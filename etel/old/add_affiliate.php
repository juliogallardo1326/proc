...
{
	$fields = array(
		'<strong>Discount Markup</strong>'=>array('name'=>'discount_markup','value'=>'10.00','detail'=>"(As % of Purchase)"),
		'<strong>Transaction Markup</strong><br>'=>array('name'=>'transaction_markup','value'=>'0.00','detail'=>"(As USD Flat-Fee)")
	);
	$app = array('title'=>'New Affiliate Signup','fields'=>$fields);
