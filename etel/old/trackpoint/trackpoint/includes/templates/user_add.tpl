...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td class="heading1">%%LNG_CreateUser%%</td>
			  </tr>
			<tr>
				<td class=body><br>%%LNG_Help_CreateUser%%</td>
			</tr>
			<tr>
				<td>
					%%GLOBAL_Message%%
			...
			<tr><td class=heading2 colspan=2>%%LNG_UserDetails%%</td></tr>
				<tr>
					...
					<td>
						<input type="text" name="tp_username" value="%%GLOBAL_UserName%%" class="field250">
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
				...
				<tr>
					...
					<td>
						<input type="checkbox" name="status" value="1" checked> %%LNG_YesIsActive%% %%LNG_HLP_Active%%
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
...
<script language="javascript">
	...
	function CheckForm() {
		f = document.forms[0];
		if (f.username.value == "") {
			alert("%%LNG_SupplyUserUsername%%");
			f.username.focus();
			return false;
		}
		if (f.password.value == "") {
			alert("%%LNG_SupplyUserPassword%%");
			f.password.focus();
			return false;
		}
		if (f.password.value != "") {
