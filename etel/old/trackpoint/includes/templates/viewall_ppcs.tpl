					...
					<TD vAlign="top" width="">
						...
						<table border=0 cellspacing="1" cellpadding="2" width=100% class=text>
							<tr class=heading3>
								...
								<td style="width:40%">&nbsp;&nbsp;%%GLOBAL_Title%%&nbsp;<a href='index.php?Page=%%PAGE%%&SortBy=%%GLOBAL_Sort%%&Sort=Up&%%GLOBAL_SearchDetails%%'><img src="images/sortup.gif" border=0></a>&nbsp;<a href='index.php?Page=%%PAGE%%&SortBy=%%GLOBAL_Sort%%&Sort=Down&%%GLOBAL_SearchDetails%%'><img src="images/sortdown.gif" border=0></a></td>
								...
								<td style="width:10%">%%LNG_Cost%%&nbsp;<a href='index.php?Page=%%PAGE%%&SortBy=Cost&Sort=Up&%%GLOBAL_SearchDetails%%'><img src="images/sortup.gif" border=0></a>&nbsp;<a href='index.php?Page=%%PAGE%%&SortBy=Cost&Sort=Down&%%GLOBAL_SearchDetails%%'><img src="images/sortdown.gif" border=0></a></td>
								...
								<td>%%LNG_ROI%%&nbsp;<a href='index.php?Page=%%PAGE%%&SortBy=ROI&Sort=Up&%%GLOBAL_SearchDetails%%'><img src="images/sortup.gif" border=0></a>&nbsp;<a href='index.php?Page=%%PAGE%%&SortBy=ROI&Sort=Down&%%GLOBAL_SearchDetails%%'><img src="images/sortdown.gif" border=0></a></td>
							</tr>
