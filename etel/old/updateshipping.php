...
$i_count = (isset($HTTP_POST_VARS["icount"])?Trim($HTTP_POST_VARS["icount"]):"");
$update_no =0;
for($i=1;$i<=$i_count;$i++) {
	$trans_id = (isset($HTTP_POST_VARS["tid$i"])?Trim($HTTP_POST_VARS["tid$i"]):"");
	$shipping_no = (isset($HTTP_POST_VARS["shipping$i"])?Trim($HTTP_POST_VARS["shipping$i"]):"");
	if($shipping_no !="") {
