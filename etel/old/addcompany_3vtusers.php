  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="50%">
      ...
      <tr>
		...
		<td height="22" align="center" valign="middle" width="50%" background="images/menucenterbg.gif" ><span class="whitehd">Add User</span></td>
	...
	<form name="adduser" action="addcompany_3vtusersfb.php"  method="post" onsubmit="javascript:return validation();">
...
<?php
		$qry_select = "Select id,username,password from cs_companyusers where teleusertype='0' and userid=$sessioncompanyid";
...
?>
			...
			<td valign="middle" class="ltbtbd"><font face="verdana" size="1"><a href="addcompany_3vtusers.php?uid=<?=$i_userid?>">Edit</a></font></td>
			<td valign="middle" class="ltbtbd1"><font face="verdana" size="1"><a href="deleteteleuser.php?uid=<?=$i_userid?>&type=comp">Delete</a></font></td>
			</tr>
<?php		}
		}
?>
