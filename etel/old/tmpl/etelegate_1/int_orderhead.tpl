  ...
  <tr>
    <td background="{$tempdir}images/order_01.gif"><table width="740" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="298"><img src="{$tempdir}images/order_etel.jpg" width="298" height="94"></td>
          <td width="417"><table width="417" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="37" align="right" bgcolor="#99CCFF" class="tabledigit">{if $cs_URL}{#OP_SiteHead#} &quot;{$cs_URL}&quot;{/if}</td>
              </tr>
              <tr>
