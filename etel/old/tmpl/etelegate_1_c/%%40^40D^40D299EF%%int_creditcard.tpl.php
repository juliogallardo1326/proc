<?php /* Smarty version 2.6.9, created on 2006-04-01 22:57:20
...
<a href="#" class="style1" onClick='javascript:window.open("https://www.etelegate.com/images/creditcard.gif","","width=500,height=350")' ></a></span><span class="fieldname1"><a href="#" class="style1" onClick='javascript:window.open("https://www.etelegate.com/images/creditcard.gif","","width=500,height=350")' ><br>
          ...
          <tr>
            ...
            <td class="style1"><select size="1" id="cardtype"  name="cardtype" style="font-size: 8pt; font-family: Verdana; width:150px;" onChange="setDescriptor(this.value)" title="reqmenu" >
                <option value="Visa" selected>Visa</option>
                <!--option value="Master" disabled>Master Card (Temporarily Not Available)</option-->
              </select><BR />MasterCard Temporarily Unavailable.
            </td>
          </tr>
          <tr>
