<?php /* Smarty version 2.6.9, created on 2005-05-17 04:23:12
...
images/cp_01.gif" height="72" width="339"></td>
                <td valign="bottom"><div align="right"><img src="<?php echo $this->_tpl_vars['tempdir']; ?>
images/Control_Panel.jpg" height="45" width="278"></div></td>
              </tr>
              <tr> 
                <td valign="bottom"><div align="right"><img src="<?php echo $this->_tpl_vars['tempdir']; ?>
images/cp_number.gif" height="27" width="356"></div></td>
              </tr>
            </tbody></table></td>
        </tr>
        <tr> 
          <td colspan="2"><img src="<?php echo $this->_tpl_vars['tempdir']; ?>
images/cp_08.gif" alt="" height="20" width="950"></td>
        </tr>
        <tr> 
...
?>
                      <tr> 
                        <td>&nbsp;</td>
                        <td><a href="<?php echo $this->_tpl_vars['rootdir'];  echo $this->_tpl_vars['link']['href']; ?>
...
<?php endforeach; endif; unset($_from); ?>
                      ...
                      <tr> 
                        <td width="14%">&nbsp;</td>
                        <td width="86%"><a href="/support/index.php?caseid=NewTicket" class="a1">Report a Bug</a></td>
                      </tr>
                    </tbody>
                  </table>
				<?php endif; ?>
...
images/spacer.gif" width="1" height="1"></td>
    ...
    foreach ($_from as $this->_tpl_vars['link']):
?>
			<td height="20" width="150" class="blackrgt" valign="middle" align="center"><a href="<?php echo $this->_tpl_vars['rootdir'];  echo $this->_tpl_vars['link']['href']; ?>
