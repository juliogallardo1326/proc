...
<tr>
<td valign="top" align="left" bgcolor="#ffffff" width="35%">&nbsp;<img alt='' border='0' src='{$tempdir}images/ecomlogo.gif'></td>
...
" bgcolor="#FFFFFF">
  <td background="{$tempdir}images/midbg.gif" align="center">
<img alt="" border="0" src="{$tempdir}images/break.gif" height="27">
{foreach from=$main_header.links item=link}
<a href="{$rootdir}{$link.href}">
<img border="0" src="{$tempdir}{$link.img}"  height="27">
</a>
<img border="0" src="{$tempdir}images/break.gif"  height="27">
{/foreach}
</td>
</tr> 
</table>
<!--topmenu ends-->
		...
		<tr>
		<td height="5" background="images/menubtmbg.gif"><img alt="" src="{$tempdir}images/spacer.gif" width="1" height="1"></td>
		</tr>
		<tr>
		...
		{foreach from=$sub_header.links item=link}
			<td height="20" class="blackrgt" valign="middle" align="center"><a href="{$link.href}" class="maintx">{$link.text}</a></td>
		{/foreach}
		</tr>
		</table>
		</td>
