...
<tr>
  <td width="100%" valign="top" align="left"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<a href="https://www.MatureBill.com"><img src='{$tempdir}images/index_01.gif' alt='' border='0'></a></td>
        <td align="right">
...
&nbsp;<br>
      {#OP_CCExample#}<a href="#" class="style1" onClick='javascript:window.open("https://www.MatureBill.com/images/creditcard.gif","","width=500,height=350")' ></a><span class="fieldname1"><a href="#" class="style1" onClick='javascript:window.open("https://www.MatureBill.com/images/creditcard.gif","","width=500,height=350")' ><br>
      CVV2</a>&nbsp;
