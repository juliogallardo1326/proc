<?php
$day = (isset($HTTP_GET_VARS['day'])?trim($HTTP_GET_VARS['day']):"");
$recur_charge = (isset($HTTP_GET_VARS['recur_charge'])?trim($HTTP_GET_VARS['recur_charge']):"");
$mon=(isset($HTTP_GET_VARS['mon'])?trim($HTTP_GET_VARS['mon']):"");
 $curr=(isset($HTTP_GET_VARS['curr'])?trim($HTTP_GET_VARS['curr']):"");
 $week=(isset($HTTP_GET_VARS['week'])?trim($HTTP_GET_VARS['week']):"");
$i_recur_start_month = (isset($HTTP_GET_VARS['opt_recur_month'])?trim($HTTP_GET_VARS['opt_recur_month']):"");
$i_recur_start_day = (isset($HTTP_GET_VARS['opt_recur_day'])?trim($HTTP_GET_VARS['opt_recur_day']):"");
$i_recur_start_year = (isset($HTTP_GET_VARS['opt_recur_year'])?trim($HTTP_GET_VARS['opt_recur_year']):"");
$productdescription= (isset($HTTP_GET_VARS['productdescription'])?trim($HTTP_GET_VARS['productdescription']):"");
$mode= (isset($HTTP_GET_VARS['mode'])?trim($HTTP_GET_VARS['mode']):"");

$text="";
$recurtimes= (isset($HTTP_GET_VARS['recur_times'])?trim($HTTP_GET_VARS['recur_times']):"");			
