<?php /* Smarty version 2.6.2, created on 2006-10-20 00:13:09
         compiled from manage/general.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'manage/general.tpl.html', 297, false),array('function', 'html_options', 'manage/general.tpl.html', 401, false),)), $this); ?>
...
" class="default">
                  <table>
                    ...
                    <tr>
                      ...
                      <td width="80%">
                        <input type="text" name="email_routing[address_prefix]" value="<?php if ($this->_tpl_vars['setup']['email_routing']['address_prefix']):  echo $this->_tpl_vars['setup']['email_routing']['address_prefix'];  else: ?>issue_<?php endif; ?>" class="default">
                        <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
" class="default">
                  <table>
                    ...
                    <tr>
                      ...
                      <td width="80%">
                        <input type="text" name="note_routing[address_prefix]" value="<?php if ($this->_tpl_vars['setup']['note_routing']['address_prefix']):  echo $this->_tpl_vars['setup']['note_routing']['address_prefix'];  else: ?>note_<?php endif; ?>" class="default">
                        <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
" class="default">
                  <table>
                    ...
                    <tr>
                      ...
                      <td width="80%">
                        <input type="text" name="draft_routing[address_prefix]" value="<?php if ($this->_tpl_vars['setup']['draft_routing']['address_prefix']):  echo $this->_tpl_vars['setup']['draft_routing']['address_prefix'];  else: ?>draft_<?php endif; ?>" class="default">
                        <?php $_smarty_tpl_vars = $this->_tpl_vars;
