<?php /* Smarty version 2.6.2, created on 2006-10-19 17:21:06
...
" align="center"><input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['prc_id']; ?>
"></td>
...
" align="center" class="default">
                        <i>No categories could be found.</i>
                      </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
