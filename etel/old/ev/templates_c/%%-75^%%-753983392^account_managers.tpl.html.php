<?php /* Smarty version 2.6.2, created on 2006-10-19 17:02:15
         compiled from manage/account_managers.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'manage/account_managers.tpl.html', 61, false),array('function', 'cycle', 'manage/account_managers.tpl.html', 145, false),)), $this); ?>
...
">
              ...
              <tr>
                <td colspan="2" class="default">
                  <b>Manage Customer Account Managers</b>
                </td>
              </tr>
...
" align="center" class="error">
                  <?php if ($_POST['cat'] == 'new'): ?>
                    <?php if ($this->_tpl_vars['result'] == -1): ?>
                      An error occurred while trying to add the new account manager.
                    <?php elseif ($this->_tpl_vars['result'] == 1): ?>
                      Thank you, the account manager was added successfully.
                    <?php endif; ?>
                  <?php elseif ($_POST['cat'] == 'update'): ?>
                    <?php if ($this->_tpl_vars['result'] == -1): ?>
                      An error occurred while trying to update the account manager information.
                    <?php elseif ($this->_tpl_vars['result'] == 1): ?>
                      Thank you, the account manager was updated successfully.
                    <?php endif; ?>
                  <?php endif; ?>
                </td>
              </tr>
...
">
                  <select name="type" class="default">
                    <option value="primary" <?php if ($this->_tpl_vars['info']['cam_type'] == 'primary'): ?>selected<?php endif; ?>>Primary Technical Account Manager</option>
                    <option value="backup" <?php if ($this->_tpl_vars['info']['cam_type'] == 'backup'): ?>selected<?php endif; ?>>Backup Technical Account Manager</option>
                  </select>
                </td>
              </tr>
              <tr>
...
" align="center">
                  <?php if ($_GET['cat'] == 'edit'): ?>
                  <input class="button" type="submit" value="Update Account Manager">
                  <?php else: ?>
                  <input class="button" type="submit" value="Create Account Manager">
                  <?php endif; ?>
              ...
              <tr>
                <td colspan="2" class="default">
                  <b>Existing Customer Account Managers:</b>
                </td>
              </tr>
              <tr>
                <td colspan="2">
                  ...
                  function checkDelete(f)
                  {
                      if (!hasOneChecked(f, \'items[]\')) {
                          alert(\'Please select at least one of the account managers.\');
                          return false;
                      }
                      if (!confirm(\'This action will remove the selected account managers.\')) {
                          return false;
                      } else {
                          return true;
                      }
...
" class="default_white">&nbsp;<b>Customer</b></td>
                      <td width="40%" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" class="default_white">&nbsp;<b>Account Manager</b></td>
...
" align="center" class="default">
                        <i>No account managers could be found.</i>
                      </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
