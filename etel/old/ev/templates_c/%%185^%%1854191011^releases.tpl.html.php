<?php /* Smarty version 2.6.2, created on 2006-10-23 15:37:42
...
" align="center"><input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['pre_id']; ?>
"></td>
...
" align="center" class="default">
                        <i>No releases could be found.</i>
                      </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
