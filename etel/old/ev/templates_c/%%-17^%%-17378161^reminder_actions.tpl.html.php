<?php /* Smarty version 2.6.2, created on 2006-10-21 18:14:40
         compiled from manage/reminder_actions.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'manage/reminder_actions.tpl.html', 74, false),array('function', 'html_options', 'manage/reminder_actions.tpl.html', 125, false),array('function', 'cycle', 'manage/reminder_actions.tpl.html', 246, false),)), $this); ?>
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="left" class="default">
                        <b>Manage Reminder Actions</b>
                      </td>
                      <td align="right" class="default">
                        (<a href="reminders.php?cat=edit&id=<?php echo $this->_tpl_vars['rem_id']; ?>
" class="link" title="view reminder details">Reminder #<?php echo $this->_tpl_vars['rem_id']; ?>
...
unset($_smarty_tpl_vars);
 ?>
              ...
              <tr>
                <td width="120" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" class="default_white">
                  <b>Alert Group Leader:</b>
                </td>
                <td bgcolor="<?php echo $this->_tpl_vars['light_color']; ?>
" class="default">
                  <input type="radio" name="alert_group_leader" value="1" <?php if ($this->_tpl_vars['info']['rma_alert_group_leader']): ?>checked<?php endif; ?>> 
                  <a id="link" class="link" href="javascript:void(null);" onClick="javascript:checkRadio('reminder_form', 'alert_group_leader', 0);">Yes</a>&nbsp;&nbsp;
                  <input type="radio" name="alert_group_leader" value="0" <?php if (! $this->_tpl_vars['info']['rma_alert_group_leader']): ?>checked<?php endif; ?>> 
                  <a id="link" class="link" href="javascript:void(null);" onClick="javascript:checkRadio('reminder_form', 'alert_group_leader', 1);">No</a>
                </td>
              </tr>
              <tr>
                <td width="120" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" class="default_white">
                ...
                <td bgcolor="<?php echo $this->_tpl_vars['light_color']; ?>
" class="default">
                  <input type="radio" name="alert_irc" value="1" <?php if ($this->_tpl_vars['info']['rma_alert_irc']): ?>checked<?php endif; ?>> 
                  <a id="link" class="link" href="javascript:void(null);" onClick="javascript:checkRadio('reminder_form', 'alert_irc', 0);">Yes</a>&nbsp;&nbsp;
                  <input type="radio" name="alert_irc" value="0" <?php if (! $this->_tpl_vars['info']['rma_alert_irc']): ?>checked<?php endif; ?>> 
                  <a id="link" class="link" href="javascript:void(null);" onClick="javascript:checkRadio('reminder_form', 'alert_irc', 1);">No</a>
                </td>
              </tr>
              <tr>
                <td width="120" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" class="default_white">
                ...
                <td bgcolor="<?php echo $this->_tpl_vars['light_color']; ?>
">
                  <input type="text" size="40" class="default" name="boilerplate" value="<?php echo $this->_tpl_vars['info']['rma_boilerplate']; ?>
">
                  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "error_icon.tpl.html", 'smarty_include_vars' => array('field' => 'boilerplate')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
                  <span class="small_default"><i>(this will show up on the bottom of the reminder messages)</i></span>
                </td>
              </tr>
              <tr>
                <td colspan="2" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
...
" class="link">Back to Reminder List</a>)
                </td>
              </tr>
              <tr>
                <td colspan="2">
...
" align="center"><input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['rma_id']; ?>
"></td>
...
" class="default">
                        &nbsp;<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['rmt_title']; ?>

                        <?php if ($this->_tpl_vars['list'][$this->_sections['i']['index']]['rma_alert_irc']): ?> [Alert IRC]<?php endif; ?>
                        <?php if ($this->_tpl_vars['list'][$this->_sections['i']['index']]['rma_alert_group_leader']): ?> [Alert Group Leader]<?php endif; ?>
                      </td>
                      <td bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<a href="reminder_conditions.php?rem_id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['rma_rem_id']; ?>
...
" class="link"><?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['total_conditions']; ?>
 Condition<?php if ($this->_tpl_vars['list'][$this->_sections['i']['index']]['total_conditions'] != 1): ?>s<?php endif; ?></a><br />
                        <?php if ($this->_tpl_vars['list'][$this->_sections['i']['index']]['status'] != ''): ?>&nbsp;Status: <?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['status'];  endif; ?>
                      </td>
                    </tr>
                    <?php endfor; else: ?>
                    <tr>
