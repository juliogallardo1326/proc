<?php /* Smarty version 2.6.2, created on 2006-10-20 00:32:49
         compiled from emails.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'emails.tpl.html', 146, false),array('function', 'html_options', 'emails.tpl.html', 219, false),array('modifier', 'escape', 'emails.tpl.html', 182, false),array('modifier', 'replace', 'emails.tpl.html', 187, false),array('modifier', 'default', 'emails.tpl.html', 196, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "header.tpl.html", 'smarty_include_vars' => array('extra_title' => 'Associate Emails')));
...
<?php elseif ($this->_tpl_vars['no_access'] == 1): ?>
  <table width="300" align="center">
    <tr>
      <td>
        &nbsp;<span class="default"><b>Sorry, but you do not have access to this page.</b>
        <br /><br />
        &nbsp;<a class="link" href="javascript:history.go(-1);">Go Back</a></span>
        <br /><br />
      </td>
...
function associateEmails(f)
{
    ...
    if (f.issue.options[f.issue.selectedIndex].value == \'support\') {
        ...
        var issue_id = getSelectedOption(f, \'issue\');
...
"></a><?php endif; ?>
          ...
          <td align="center" class="default_white" nowrap>
            <a title="sort by sender" href="<?php echo $this->_tpl_vars['sorting']['links']['sup_customer_id']; ?>
" class="white_link">Customer</a>
            <?php if ($this->_tpl_vars['sorting']['images']['sup_customer_id'] != ""): ?><a title="sort by customer" href="<?php echo $this->_tpl_vars['sorting']['links']['sup_customer_id']; ?>
