...
smarty_core_load_plugins(array('plugins' => array(array('function', 'get_display_style', 'email_filter_form.tpl.html', 92, false),array('function', 'html_options', 'email_filter_form.tpl.html', 118, false),array('function', 'html_select_date', 'email_filter_form.tpl.html', 138, false),array('modifier', 'escape', 'email_filter_form.tpl.html', 104, false),)), $this); ?>
              ...
              <tr>
                <td nowrap width="50%">
                  ...
                  <select name="arrival_date[filter_type]" class="default" onChange="javascript:checkDateFilterType(this.form, this);">
                    <option <?php if ($this->_tpl_vars['options']['arrival_date']['filter_type'] == 'greater'): ?>selected<?php endif; ?> value="greater">Greater Than</option>
                    <option <?php if ($this->_tpl_vars['options']['arrival_date']['filter_type'] == 'less'): ?>selected<?php endif; ?> value="less">Less Than</option>
