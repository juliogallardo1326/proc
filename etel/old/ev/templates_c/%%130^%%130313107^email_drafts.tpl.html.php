<?php /* Smarty version 2.6.2, created on 2006-10-20 07:21:19
         compiled from email_drafts.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'email_drafts.tpl.html', 44, false),array('modifier', 'escape', 'email_drafts.tpl.html', 74, false),array('modifier', 'default', 'email_drafts.tpl.html', 78, false),array('function', 'get_innerhtml', 'email_drafts.tpl.html', 48, false),array('function', 'get_display_style', 'email_drafts.tpl.html', 55, false),array('function', 'cycle', 'email_drafts.tpl.html', 67, false),)), $this); ?>
...
<?php if ($_REQUEST['show_all_drafts'] == 1): ?>
  <?php $this->assign('draft_col_count', '7');  else: ?>
  <?php $this->assign('draft_col_count', '6');  endif; ?>
<br />
...
unset($_smarty_tpl_vars);
 ?></td>
                ...
                <?php if ($_REQUEST['show_all_drafts'] == 1): ?>
                <td width="5%" class="default_white">Status</td>
                <?php endif; ?>
                <td width="20%" class="default_white">From</td>
                <td width="20%" class="default_white">To</td>
                <td width="20%" class="default_white" nowrap>Last Updated Date</td>
                <td width="40%" class="default_white">Subject</td>
              </tr>
...
" align="center">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="20%">&nbsp;</td>
                      <td width="60%" align="center"><input type="button" value="Create Draft" class="button" onClick="javascript:createDraft(<?php echo $_GET['id']; ?>
);"></td>
                      <td width="20%" align="right">
                        <input type="checkbox" name="show_all_drafts" id="show_all_drafts" value="1" <?php if ($_REQUEST['show_all_drafts'] == 1): ?>checked<?php endif; ?> onClick="javascript:showAllDrafts(this)"><span class="default_white"><label for="show_all_drafts">Show All Drafts</label></span>
                      </td>
                    </tr>
                  </table>
                </td>
