<?php /* Smarty version 2.6.2, created on 2006-10-19 23:55:48
         compiled from notification.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'notification.tpl.html', 154, false),array('modifier', 'escape', 'notification.tpl.html', 158, false),)), $this); ?>
...
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['allowed_emails']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
allowed_emails[allowed_emails.length] = '<?php echo $this->_tpl_vars['allowed_emails'][$this->_sections['i']['index']]; ?>
';
...
function validate(f)
{
    ...
    if (!inArray(email, allowed_emails)) {
        var msg = "The given email address \'" + f.email.value + "\' is neither a known staff member or customer technical contact.";
        msg += "\\nAre you sure you want to add this address to the notification list?";
        if (!confirm(msg)) {
            return false;
        } else {
            return true;
...
" align="center" class="error">
            ...
            <?php elseif ($this->_tpl_vars['update_result'] == -2): ?>
              Error: the given email address is not allowed to be added to the notification list.
...
">
            <input type="text" name="email" size="40" class="default" value="<?php if ($this->_tpl_vars['info']['sub_email'] != ''):  echo $this->_tpl_vars['info']['sub_email'];  else:  echo $this->_tpl_vars['current_email'];  endif; ?>">
...
" class="default_white">
          ...
          <td bgcolor="<?php echo $this->_tpl_vars['light_color']; ?>
" class="default">
            <input type="checkbox" name="actions[]" <?php if (( $this->_tpl_vars['info'] == '' && $this->_tpl_vars['default_actions']['emails'] == 1 ) || $this->_tpl_vars['info']['emails'] == 1): ?>checked<?php endif; ?> value="emails"> <a id="link" class="link" href="javascript:void(null);" onClick="javascript:toggleCheckbox('notification_form', 'actions[]', 0);">Emails are Received or Sent</a><br />
            <input type="checkbox" name="actions[]" <?php if ($this->_tpl_vars['info'] == '' || $this->_tpl_vars['info']['updated'] == 1): ?>checked<?php endif; ?> value="updated"> <a id="link" class="link" href="javascript:void(null);" onClick="javascript:toggleCheckbox('notification_form', 'actions[]', 1);">Overview or Details are Changed</a><br />
            <input type="checkbox" name="actions[]" <?php if ($this->_tpl_vars['info'] == '' || $this->_tpl_vars['info']['closed'] == 1): ?>checked<?php endif; ?> value="closed"> <a id="link" class="link" href="javascript:void(null);" onClick="javascript:toggleCheckbox('notification_form', 'actions[]', 2);">Issue is Closed</a><br />
            <input type="checkbox" name="actions[]" <?php if ($this->_tpl_vars['info'] == '' || $this->_tpl_vars['info']['files'] == 1): ?>checked<?php endif; ?> value="files"> <a id="link" class="link" href="javascript:void(null);" onClick="javascript:toggleCheckbox('notification_form', 'actions[]', 3);">Files are Attached</a>
          </td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
...
" align="center" class="default">
                  <i>No subscribers could be found.</i>
                </td>
              </tr>
              <?php endif; ?>
              <?php if ($this->_tpl_vars['current_role'] > $this->_tpl_vars['roles']['reporter']): ?>
