<?php /* Smarty version 2.6.2, created on 2006-10-23 02:29:30
         compiled from forgot_password.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'forgot_password.tpl.html', 58, false),array('modifier', 'escape', 'forgot_password.tpl.html', 58, false),)), $this); ?>
...
<?php if (! $this->_tpl_vars['result']):  $_smarty_tpl_vars = $this->_tpl_vars;
      ...
      <table bgcolor="#006486" width="100%" border="0" cellspacing="0" cellpadding="4">
        <tr>
          <td colspan="2" align="center">
            <h2 style="color: white;">Request a Password</h2>
        ...
        <tr>
          <td colspan="2" align="center" class="error">
            ...
            <?php elseif ($this->_tpl_vars['result'] == 5): ?>
              Error: No user account was found matching the entered email address.
            <?php endif; ?>
            </b>
          </td>
        </tr>
