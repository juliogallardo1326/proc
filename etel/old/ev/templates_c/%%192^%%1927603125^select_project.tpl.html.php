<?php /* Smarty version 2.6.2, created on 2006-10-20 01:29:40
  ...
  <tr>
    <td>
      <table bgcolor="#006486" width="100%" border="0" cellspacing="0" cellpadding="4">
        ...
        <tr>
          <td colspan="2" align="center" class="error">
            ...
            <?php if ($this->_tpl_vars['err'] == 1 || $_GET['err'] == 1): ?>
              You are not allowed to use the selected dept.
            <?php endif; ?>
            </b>
          </td>
        </tr>
        <?php endif; ?>
        <tr>
          <td align="right" width="40%" class="default_white"><b><u>Department</u>:</b></td>
          <td width="60%">
