<?php /* Smarty version 2.6.2, created on 2006-10-26 14:05:38
         compiled from main.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'main.tpl.html', 28, false),)), $this); ?>
        ...
        <tr>
          <td width="100%">
            <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td>
                  <span class="default"><b>Overall Stats</b> <span style="font-size:smaller"> (Unanswered/Total)</span></span>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['status'][$this->_sections['i']['index']]['sta_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
                      ...
                      <td align="right" class="default"><?php echo $this->_tpl_vars['status'][$this->_sections['i']['index']]['unanswered_items']; ?>
 / <?php echo $this->_tpl_vars['status'][$this->_sections['i']['index']]['total_items']; ?>
</td>
                    </tr>
                    <?php endfor; else: ?>
                    <tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['releases'][$this->_sections['i']['index']]['pre_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
                      ...
                      <td align="right" class="default"><?php echo $this->_tpl_vars['releases'][$this->_sections['i']['index']]['unanswered_items']; ?>
 / <?php echo $this->_tpl_vars['releases'][$this->_sections['i']['index']]['total_items']; ?>
</td>
                    </tr>
                    <?php endfor; else: ?>
                    <tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['priorities'][$this->_sections['i']['index']]['pri_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
                      ...
                      <td align="right" class="default"><?php echo $this->_tpl_vars['priorities'][$this->_sections['i']['index']]['unanswered_items']; ?>
 / <?php echo $this->_tpl_vars['priorities'][$this->_sections['i']['index']]['total_items']; ?>
</td>
                    </tr>
                    <?php endfor; else: ?>
                    <tr>
...
&status=&priority=&release="><?php echo ((is_array($_tmp=$this->_tpl_vars['categories'][$this->_sections['i']['index']]['prc_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
                      ...
                      <td align="right" class="default"><?php echo $this->_tpl_vars['categories'][$this->_sections['i']['index']]['unanswered_items']; ?>
 / <?php echo $this->_tpl_vars['categories'][$this->_sections['i']['index']]['total_items']; ?>
</td>
                    </tr>
                    <?php endfor; else: ?>
                    <tr>
...
"><?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['usr_full_name']; ?>
                      ...
                      <td align="right" class="default"><?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['unanswered_items']; ?>
 / <?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['total_items']; ?>
</td>
                    </tr>
                    <?php endfor; else: ?>
                    <tr>
...
unset($_smarty_tpl_vars);
 ?>
      <?php if ($this->_tpl_vars['app_setup']['daily_tips'] == 'enabled' && $this->_tpl_vars['random_tip']): ?>
      <table width="100%" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" border="0" cellspacing="0" cellpadding="1" align="center">
        <tr>
          <td width="100%">
            <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td>
                  <span class="default"><b>Information</b></span></td>
              </tr>
              <tr>
...
unset($_smarty_tpl_vars);
 ?>
      ...
      <br />
      <?php endif; ?>
      <?php if ($this->_tpl_vars['pie_chart'] && $this->_tpl_vars['current_role'] > $this->_tpl_vars['roles']['developer']): ?>
      <table width="100%" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" border="0" cellspacing="0" cellpadding="1" align="center">
        <tr>
          <td width="100%">
...
stats_chart.php?plot=status&scale=2.5" target="_blank"><img border="0" width="360" height="200" src="<?php echo $this->_tpl_vars['rel_url']; ?>
stats_chart.php?plot=status"></a>
                  <a href="<?php echo $this->_tpl_vars['rel_url']; ?>
stats_chart.php?plot=priority&scale=2.5" target="_blank"><img border="0" width="360" height="200" src="<?php echo $this->_tpl_vars['rel_url']; ?>
stats_chart.php?plot=priority"></a>
                  <a href="<?php echo $this->_tpl_vars['rel_url']; ?>
stats_chart.php?plot=user&scale=2.5" target="_blank"><img border="0" width="360" height="200" src="<?php echo $this->_tpl_vars['rel_url']; ?>
stats_chart.php?plot=user"></a>
                  <a href="<?php echo $this->_tpl_vars['rel_url']; ?>
stats_chart.php?plot=release&scale=2.5" target="_blank"><img border="0" width="360" height="200" src="<?php echo $this->_tpl_vars['rel_url']; ?>
stats_chart.php?plot=release"></a>
                  <a href="<?php echo $this->_tpl_vars['rel_url']; ?>
stats_chart.php?plot=category&scale=2.5" target="_blank"><img border="0" width="360" height="200" src="<?php echo $this->_tpl_vars['rel_url']; ?>
stats_chart.php?plot=category"></a>
                </td>
              </tr>
            </table>
          </td>
