<?php /* Smarty version 2.6.2, created on 2006-10-21 18:58:05
         compiled from mail_queue.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'mail_queue.tpl.html', 28, false),array('modifier', 'escape', 'mail_queue.tpl.html', 31, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "header.tpl.html", 'smarty_include_vars' => array('extra_title' => 'Mail Queue')));
  ...
  <table bgcolor="#FFFFFF" width="100%" cellspacing="1" cellpadding="2" border="0">
    <tr>
      <td class="default" nowrap>
        <b>Mail Queue for Issue #<?php echo $this->_tpl_vars['issue_id']; ?>
</b>
      </td>
    </tr>
    <tr>
...
unset($_smarty_tpl_vars);
 ?></td>
            <td width="20%" class="default_white">Recipient</td>
            <td width="20%" class="default_white" nowrap>Queued Date</td>
            <td width="10%" class="default_white">Status</td>
...
" class="default" align="center">
              <i>No mail queue could be found.</i>
            </td>
          </tr>
          <?php endif; ?>
          <tr>
