    ...
    function save()
    {
        ...
        foreach ($date_fields as $field_name) {
            ...
            if (@$HTTP_POST_VARS['filter'][$field_name] == 'yes') {
                ...
                } elseif (($$filter_type_var == "'null'") || ($$filter_type_var == "'in_past'") || ($$filter_type_var == "'not_in_past'")) {
                    $$date_var = "NULL";
                    $$date_end_var = "NULL";
                } else {
                    $$date_end_var = "NULL";
        ...
        if ($cst_id != 0) {
            $stmt = "UPDATE
                     ...
                     SET
                        ...
                        cst_hide_answered='" . Misc::escapeInteger(@$HTTP_POST_VARS["hide_answered"]) . "',
            ...
            $stmt = "INSERT INTO
                     ...
                     (
                        ...
                        '" . Misc::escapeInteger(@$HTTP_POST_VARS["hide_answered"]) . "',
    ...
    function buildOptions($details, $info)
    {
        ...
        foreach ($info as $field => $filter) {
            if (@$filter['is_date'] == true) {
                ...
                if ($details['cst_' . $field . '_filter_type'] == 'in_past' || $details['cst_' . $field . '_filter_type'] == 'not_in_past') {
