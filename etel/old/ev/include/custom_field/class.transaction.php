...
include_once("class.dynamic.php");
 ...
 */
class Transaction_Custom_Field_Backend extends Dynamic_Custom_Field_Backend
{
	var $showTransactionLookup = "custom_fields_form_translookup.tpl.html";
