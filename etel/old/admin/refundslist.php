...
function Displaycompanytype() {
	...
	document.frm_cancel_requests.action = "refundrequests.php";
	document.frm_cancel_requests.submit();
			...
			<tr>
			<td height="22" align="left" valign="top" width="3%" background="../images/menucenterbg.gif" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menutopleft.gif" width="8" height="22"></td>
			      <td height="22" align="center" valign="middle" width="45%" background="../images/menucenterbg.gif" ><span class="whitehd">Refunded Transactions</span></td>
			      <td height="22" align="left" valign="top" width="14%" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menutopcurve.gif" width="49" height="22"></td>
			<td height="22" align="left" valign="top" width="35%" background="../images/menutoprightbg.gif" ><img alt="" SRC="<?=$tmpl_dir?>/images/spacer.gif" width="1" height="1"></td>
			<td height="22" align="right" valign="top" background="../images/menutoprightbg.gif"  width="3%" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menuright.gif" width="10" height="22"></td>
			</tr>
			<tr>
		 ...
		 <tr>
			...
			<tr>
			 <td height="30" valign="middle" align="right" width="23%"><font face="verdana" size="1">Bank</font></td>
		...
		<tr>
		<td width="3%"><img SRC="<?=$tmpl_dir?>/images/menubtmleft.gif"></td>
...
<?php
	...
	if ($str_from_date != "")
	{
		   ...
		   $qry_select="Select B.*,C.userId,C.companyname from cs_transactiondetails B,cs_companydetails C ";
		   $qry_select .= $str_where_condition == "" ? " where " : $str_where_condition ." and ";
		   $qry_select .= " B.cancelstatus = 'Y' $bank_sql and B.userId = C.userId ";
			if($str_to_date != "")
			{
				$qry_select .= " AND B.cancellationDate BETWEEN '$str_from_date' AND '$str_to_date' ";
			}
			$qry_select .= " Order by C.companyname, B.cancellationDate desc";
			...
			if ($i_count>0)
			{
			  ...
			  while ($transInfo = mysql_fetch_assoc($rssel_report))
			  {
				if ($userId != $transInfo['userId']) {
					  ...
					  $str_data .= "<td width='4%' bgcolor='#CCCCCC' ><span class='subhd'>Cancel Ref</span></td>";
					  $str_data .= "<td width='5%' bgcolor='#CCCCCC' ><span class='subhd'>Customer Name</span></td>";
					  $str_data .= "<td width='6%' bgcolor='#CCCCCC' ><span class='subhd'>Amount</span></td>";
					 ...
					 $str_data .= "<td bgcolor='#E2E2E2'><font size='1' face='Verdana' ><a href='viewreportpage.php?id=".$transInfo['transactionId']."'>".$transInfo['cancel_refer_num']."</a></font></td>";
					 $str_data .= "<td bgcolor='#E2E2E2'><font size='1' face='Verdana' >".$transInfo['name']." &nbsp;".$transInfo['surname']."</font></td>";
					 $str_data .= "<td bgcolor='#E2E2E2'><font size='1' face='Verdana' >".$transInfo['amount']." </font></td>";
					 $str_data .= "<td bgcolor='#E2E2E2'><font size='1' face='Verdana' >".$transInfo['phonenumber']." </font></td>";
					 $str_data .= "<td bgcolor='#E2E2E2'><font size='1' face='Verdana' >".func_get_date_time_12hr($transInfo['cancellationDate'])."</font></td>";
					 $str_data .= "<td bgcolor='#E2E2E2'><font size='1' face='Verdana' >".$transInfo['reason']."<br>".$transInfo['other']."</font></td>";		 
		...
		?>
			<form name="frm_cancel_requests" action="" method="post">
			<table border="0" cellpadding="0" width="100%" cellspacing="0" height="55%" align="center">
			<tr>
			<td width="95%" valign="top" align="center">
...
Show 
	...
	<tr>
		<td colspan="14" align="center" valign="middle" height="50"><a href="refundrequests.php"><img border="0" SRC="<?=$tmpl_dir?>/images/back.jpg"></a>&nbsp;<input type="image" border="0" SRC="<?=$tmpl_dir?>/images/submit.jpg"></td>
		</tr>
		</table>							
		</td>
		</tr>
