...
<table border="0" cellpadding="0" width="100%" cellspacing="0" height="60%">
  <tr>
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		          <td height="30" valign="middle" align="left" ><font face="verdana" size="1"> 
                    <?=$periodstring?>
                    </font></td>
		          <td align="left" width="559"  height="30" >&nbsp; 
      ...
      <tr>
		  <td height="30" valign="middle" align="left" ><font face="verdana" size="1"><?=$endperiodstring?></font></td>
		          <td align="left" width="559"  height="30"  >&nbsp; 
	 ...
	 <tr>
	  	<td height="30"  valign="middle" align="left"><font face="verdana" size="1">Company</font></td>
...
<?		} ?>
                ...
                <font face="verdana" size="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Export 
                    List</font>   </td>
	</tr>
	<tr>
	              <td colspan="2"> <table width="100%" align="center" border="0">
                      <tr> 
                        <td width="15%"  height="30" align="right"  valign="middle" width="100"> 
                        ...
                        <td width="59%"  height="30" align="center"  valign="middle"  rowspan="6">
		...
		<td><select name="listnum[]" id="list54" style="font-family:verdana;font-size:8px;WIDTH:30px" disabled><option value="" selected>&nbsp;</option><?php print func_numbering_list(24);?></select><input type="checkbox" name="exportlist[]" value="misc" onClick="javascript:func_enable_select('list54');" ><font face="Verdana" size="1">Miscellaneous</font></td></tr>			  
                      ...
                      <tr> 
                        <td  height="30"  valign="middle" align="right"><font face="verdana" size="1">No 
                          Pass</font> <input type="checkbox" name="trans_nopass" value="NP"> 
                          &nbsp;</td>
                      ...
                      <tr> 
                        <td  height="30"  valign="middle" align="right" ><font face="verdana" size="1">Order 
                          entry 
                          <input type="radio" name="daterange" value="O" checked>
                          </font>&nbsp;&nbsp;</td>
                      ...
                      <tr> 
                        ...
                        <td  height="30"  valign="middle" align="right" ><font face="verdana" size="1">Check 
                          <input type="radio" name="checkorcard" value="C" checked onClick="javascript:display_list('Check','Credit');">
                          </font>&nbsp;&nbsp;</td>
                      ...
                      <tr> 
                        <td height="30"  valign="middle" align="right"><font face="verdana" size="1">Alphabetize 
                          </font>
	...
	<tr>
                  <td height="30"  align="center" width="124"></td>
</tr>
	...
	<tr>
	 <td  height="50"  valign="middle" align="center"  colspan='2'>
		 <input type="image" id="reportview" SRC="<?=$tmpl_dir?>/images/exportfile.jpg"></input>
		</td>
	</tr>
	</table>
	</form>
