...
function Displaycompanytype() {
	...
	document.ledger.action = "transactionverification.php";
...
<table border="0" cellpadding="0" width="100%" cellspacing="0" height="60%">
  <tr>
    ...
    &nbsp;
		...
		<form name="ledger" action="atmverification.php" method="POST" onsubmit="return validation();">
	...
	-->
		<tr><td colspan="2" align="center" valign="middle" width="100%">
			<table  cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
				<td valign="middle" align="right" width="40%" height="60"><font face="verdana" size="1">Select Company</font></td>
				...
				<tr>
				  <td height="30" valign="middle" align="right"  width="40%"><font face="verdana" size="1">To 
                    be billed&nbsp;&nbsp; 
<input type="checkbox" name="set_to_billdate" value="Yes"></font></td>
				  <td height="30" valign="middle" align="left"  width="60%"><font face="verdana" size="1">&nbsp;&nbsp;&nbsp;Passed 
                    but not approved&nbsp;&nbsp;<input type="checkbox" name="yet_to_be_passed" value="Yes">
                    </font></td>
				</tr>
