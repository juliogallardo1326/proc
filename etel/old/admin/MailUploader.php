...
function validation() {
trimSpace(document.mailupload.fileupload);
	if(document.mailupload.fileupload.value == "" ) {
		alert("Please enter the valid file name");
		document.mailupload.fileupload.focus();
		return false;
	} else {
		document.mailupload.method="post";
		document.mailupload.action = "mailuploader.php";
