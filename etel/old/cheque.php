...
$sessionlogin_type =isset($HTTP_SESSION_VARS["sessionlogin_type"])?$HTTP_SESSION_VARS["sessionlogin_type"]:"";
$i_company_id = (isset($HTTP_GET_VARS['companyname'])?Trim($HTTP_GET_VARS['companyname']):"");
...
else if($sessionService !="" || $sessionServiceUser !="") 
{
	$headerInclude="sessionService";
} 
else 
{
	$headerInclude="home";
...
$str_atm_verify = "";
$str_currency = "";
if($sessionlogin_type=="ecom") {
$tran_login_type = "ecom";
}else if($sessionlogin_type=="tele") {
$tran_login_type = "tele";
} else {
$tran_login_type = "pmtg";
}
 if($i_company_id !=""){
	...
	$str_atm_verify = func_get_value_of_field($cnn_cs,"cs_companydetails","atm_verify","userid",$str_company_id);
	$str_currency = func_get_processing_currency($str_company_id);
...
trimSpace(document.chequeFrm.firstname)
trimSpace(document.chequeFrm.lastname)
trimSpace(document.chequeFrm.txtproductDescription)
trimSpace(document.chequeFrm.address)
trimSpace(document.chequeFrm.city)
trimSpace(document.chequeFrm.state)
trimSpace(document.chequeFrm.zip)
trimSpace(document.chequeFrm.phonenumber)
trimSpace(document.chequeFrm.email)
trimSpace(document.chequeFrm.chequenumber)
trimSpace(document.chequeFrm.amount)
trimSpace(document.chequeFrm.bankname)
trimSpace(document.chequeFrm.bankroutingcode)
trimSpace(document.chequeFrm.bankaccountno)
if (srt_trans_type == "tele") {
	trimSpace(document.chequeFrm.authorizationno)
	trimSpace(document.chequeFrm.shippingno)
} else {
	trimSpace(document.chequeFrm.cfrm_email)
}
trimSpace(document.chequeFrm.securityno)
trimSpace(document.chequeFrm.driverlicense)
trimSpace(document.chequeFrm.misc)
trimSpace(document.chequeFrm.recur_charge)
trimSpace(document.chequeFrm.recur_times)
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" align="center">
                      ...
                      <tr> 
                        ...
                        <td class="tdbdr">&nbsp;&nbsp; <select name="state" style="font-size:11px;width:120px;font-height:10px;font-face:verdana;">
                            <script language="javascript">showStates()</script>
                          </select></td>
                      </tr>
                      <tr> 
...
<!--                <tr> 
				...
				<tr> 
                        <td align="right" class="tdbdr1" height="30"><font size="2" face="Verdana" color="#000000">Product 
                          Description : </font></td>
                  <td class="tdbdr">&nbsp;&nbsp;<font color="#001188"> 
...
<?php 				if($tran_login_type == "tele") { ?>                      
					  <tr> 
                        ...
                        <td valign="middle" class="tdbdr" width="50%"> <font color="#001188">&nbsp;&nbsp; 
                          <input type="text" name="authorizationno" size="25" maxlength="50">
                          </font></td>
                      </tr>
                      <tr> 
                ...
                <tr> 
                  <td colspan="2"> 
					...
					<tr> 
                      ...
                      <tr> 
                        <td align="right" valign="middle" class="tdbdr1" height="30"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Recurring Charge (<?=$str_currency?>) 
                          : </font></td>
                        <td valign="middle" class="tdbdr"><font color="#001188">&nbsp; 
        ...
        <tr>
		  ...
		  <?php
		  		if ( trim($_SESSION["sessionactivity_type"]) != "Test Mode" ) {
					if ($str_atm_verify == "Y") {
		  ?> 		
					<a href="#" onClick="return amt_submit();"><img border="0" src="images/atm_verify.gif"></a>&nbsp;&nbsp;
			<?php }
			?>
					<input type="image" name="add" src="images/submit.jpg"></input></td>
		  <?php
		  	} else {
				print("<font size=\"1\" face=\"Verdana\" color=\"Red\">Only active companies can add transactions.</font>");
			}			
			?>	
        </tr>
      </table>
