<?php
/**
* $Id: language_es.php,v 1.3.2.9.2.3 2006/03/23 11:36:22 thorstenr Exp $
*
* Spanish language file
*
* @author       Fernando <>
* @author       Eduardo Polidor <epolidor@gmail.com>
* @author       Eduardo Sainz <eduardosainz@gmail.com>
* @since        2004-06-24
...
$PMF_LANG["msgS2FText2"] = "Encontrarás el fichero en la siguiente dirección:";
...
$PMF_LANG["msgNewContentAddon"] = "Tu propuesta de FAQ no se publica inmediatamente, debe ser revisada por un moderador. Son campos obligatorios <strong>tu Nombre</strong>, <strong>tu dirección de correo</strong>, <strong>categoría</strong>, <strong>encabezado</strong> y <strong>tu registro</strong>. Por favor separa las palabras contraseña por un espacio de tabulación.";
...
$PMF_LANG["msgNewContentMail"] = "Tu dirección de correo:";
...
$PMF_LANG["err_noTopTen"] = "<p>No hay TOP 10 disponible aún.</p>";
$PMF_LANG["err_nothingFound"] = "<p>No se han encontrado entradas.</p>";
$PMF_LANG["err_SaveEntries"] = "Campos requeridos son <strong>tu Nombre</strong>, <strong>tu dirección de correo</strong>, <strong>categoría</strong>, <strong>encabezado</strong> y <strong>tu Registro</strong>!<br /><br />\n<a href=\"javascript:history.back();\">volver atrás</a><br /><br />\n";
$PMF_LANG["err_SaveComment"] = "Required fields are <strong>tu Nombre</strong>, <strong>tu dirección de correo</strong> y <strong>tus comentarios</strong>!<br /><br />\n<a href=\"javascript:history.back();\">volver atrás</a><br /><br />\n";
...
$PMF_LANG["err_noMailAdress"] = "Tu dirección de correo no es correcta.<br /><a href=\"javascript:history.back();\">volver</a>";
$PMF_LANG["err_sendMail"] = "Campos requeridos son <strong>tu nombre</strong>, <strong>tu dirección de correo</strong> y <strong>tu pregunta</strong>!<br /><br />\n<a href=\"javascript:history.back();\">volver atrás</a><br /><br />\n";
...
$PMF_LANG["ad_entry_keywords"] = "Palabras contraseña:";
...
$PMF_LANG["ad_entry_changed"] = "Cambios";
$PMF_LANG["ad_entry_changelog"] = "Registro de cambios:";
...
$PMF_LANG["ad_news_link_url"] = "Enlace: (<strong>sin http://</strong>)";
$PMF_LANG["ad_news_link_title"] = "Título del enlace:";
$PMF_LANG["ad_news_link_target"] = "Target del enlace";
$PMF_LANG["ad_news_link_window"] = "El enlace se abre en una nueva ventana";
$PMF_LANG["ad_news_link_faq"] = "El enlace se abre dentro del FAQ";
...
$PMF_LANG["ad_passwd_old"] = "contraseña antigua:";
...
$PMF_LANG["ad_passwd_fail"] = "La antigua contraseña <strong>debe</strong> ser escrita correctamente y ambas tienen que <strong>coincidir</strong>.";
...
$PMF_LANG["ad_config_reset"] = "Borrar";
...
$PMF_LANG["ad_csv_make"] = "Una copia de seguridad es una imagen completa de la base de datos. Esta operación debería realizarse al menos una vez al mes. El formato del backup es un fichero de transacción MySQL, que puede ser importado usando herramientas como phpMyAdmin o la línea de comandos de un cliente mysql.";
$PMF_LANG["ad_csv_link"] = "Descargar copia de seguridad";
$PMF_LANG["ad_csv_head"] = "Hacer una copia de seguridad";
...
$PMF_LANG["ad_csv_no"] = "No parece una copia de seguridad de phpmyfaq.";
...
$PMF_LANG["ad_csv_rest"] = "Restaurar copia de seguridad";
...
$PMF_LANG["ad_stat_laen"] = "Último acceso";
...
$PMF_LANG["ad_user_chpw"] = "Solamente puedes cambiar la contraseña del siguiente usuario vía \"Cambiar contraseña\".";
...
$PMF_LANG["ad_passwdsuc"] = "¡Tu contraseña ha sido cambiada!";
...
$PMF_LANG["ad_attach_2"] = "Por favor, escoge primero un enlace para los adjuntos en la configuración.";
...
$PMF_LANG["rightsLanguage"][15] = "cambiar contraseña";
...
$PMF_LANG["rightsLanguage"][19] = "crear copia de seguridad";
$PMF_LANG["rightsLanguage"][20] = "restaurar copia de seguridad";
$PMF_LANG["rightsLanguage"][21] = "borrar cuestiones abiertas";
$PMF_LANG["rightsLanguage"][22] = "editar revisiones";

$PMF_LANG["msgAttachedFiles"] = "ficheros adjuntos:";

// Added v1.3.3 - 27.05.2003 - Thorsten
$PMF_LANG["ad_user_action"] = "acción";
$PMF_LANG["ad_entry_email"] = "Dirección de correo:";
...
$PMF_LANG["err_SaveQuestion"] = "Son campos obligatorios <strong>tu Nombre</strong>, <strong>tu dirección de correo</strong> y <strong>tu pregunta</strong>!<br /><br /><a href=\"javascript:history.back();\">volver</a><br /><br />\n";

// added v1.3.4 - 23.07.2003 - Thorsten
$PMF_LANG["ad_entry_fontcolor"] = "Color de la fuente: ";
$PMF_LANG["ad_entry_fontsize"] = "Tamaño de la fuente: ";

// added v1.4.0 - 2003-12-04 by Thorsten / Mathias
$LANG_CONF["language"] = array(0 => "select", 1 => "Fichero de Idioma");
$LANG_CONF["detection"] = array(0 => "checkbox", 1 => "Habilitar negociación automática de contenido");
...
$LANG_CONF["adminmail"] = array(0 => "input", 1 => "Dirección de correo del administrador");
...
$LANG_CONF["disatt"] = array(0 => "checkbox", 1 => "¿Poner un enlace a los adjuntos bajo las entradas?");
...
$LANG_CONF["numRecordsPage"] = array(0 => "input", 1 => "Número de items mostrados por página");
$LANG_CONF["numNewsArticles"] = array(0 => "input", 1 => "Número de nuevos artículos");
$LANG_CONF["bannedIP"] = array(0 => "area", 1 => "Bloquear estas IPs");
$LANG_CONF["parse_php"] = array(0 => "checkbox", 1 => "¿Puede el motor de templates parsear código PHP (por omisión: desactivado)");
$LANG_CONF["mod_rewrite"] = array(0 => "checkbox", 1 => "¿Activar el soporte para mod_rewrite (por omisión: desactivado)");
$LANG_CONF["ldap_support"] = array(0 => "checkbox", 1 => "¿Quiere habilitar el soporte para LDAP? (por omisión: desactivado)");
...
$PMF_LANG["lostpwd_err_1"] = "Error: ¡Nombre de usuario y dirección de correo no encontrados.";
$PMF_LANG["lostpwd_err_2"] = "Error: ¡Datos inválidos!";
$PMF_LANG["lostpwd_text_1"] = "Gracias por solicitar su información de ingreso.";
$PMF_LANG["lostpwd_text_2"] = "Por favor, ingrese una nueva contraseña personal en la sección de administración de su FAQ.";
$PMF_LANG["lostpwd_mail_okay"] = "El correo ha sido enviado.";

$PMF_LANG["ad_xmlrpc_button"] = "obtenga el número de la última version de phpMyFAQ utilizando web services";
$PMF_LANG["ad_xmlrpc_latest"] = "Última version disponible en";

// added v1.5.0 - 2005-07-31 by Thorsten
$PMF_LANG['ad_categ_select'] = 'Seleccione el lenguaje de la categoría';

// added v1.5.1 - 2005-09-06 by Thorsten
$PMF_LANG['msgSitemap'] = 'Mapa del sitio';

// added v1.5.2 - 2005-09-23 by Lars
$PMF_LANG['err_inactiveArticle'] = 'Este artículo está en revisión y no puede ser mostrado.';
$PMF_LANG['msgArticleCategories'] = 'Categorías para este artículo';

// added v1.5.3 - 2005-10-04 by Thorsten and Periklis
$PMF_LANG['ad_menu_searchplugin'] = 'Plugin de búsqueda para Firefox';
$PMF_LANG['ad_search_plugin_install'] = 'Instalar el plugin de búsqueda para Firefox';
$PMF_LANG['ad_search_plugin_title'] = 'Crear un plugin de búsqueda para Firefox';
$PMF_LANG['ad_search_plugin_ttitle'] = 'Tílulo en la caja de búsqueda de Firefox:';
$PMF_LANG['ad_search_plugin_tdesc'] = 'Descripción:';
$PMF_LANG['ad_search_plugin_create'] = 'Crear un plugin de búsqueda para Firefox';
$PMF_LANG['ad_search_plugin_success'] = '¡El plugin de búsqueda para Mozilla Firefox search fue creado exitosamente!';

// added v1.6.0 - 2006-02-02 by Thorsten
$PMF_LANG['ad_entry_solution_id'] = 'ID única del articulo';
$PMF_LANG['ad_entry_faq_record'] = 'Registro de la FAQ';
$PMF_LANG['ad_entry_new_revision'] = '¿ Crear nueva revisión ?';
$PMF_LANG['ad_entry_record_administration'] = 'Administración del registro';
$PMF_LANG['ad_entry_changelog'] = 'Historial de cambios';
$PMF_LANG['ad_entry_revision'] = 'Revisión';
$PMF_LANG['ad_changerev'] = 'Seleccionar revisión';
$PMF_LANG['msgCaptcha'] = "Por favor introduce los caracteres tal y como aparecen en la imágen";
$PMF_LANG['msgSelectCategories'] = 'Buscar en ...';
$PMF_LANG['msgAllCategories'] = '... todas las categorías';
$PMF_LANG['ad_you_should_update'] = 'La versión de phpMyFAQ que está utilizando es antigua. Es recomendable que la actualize a la última versión disponible.';
