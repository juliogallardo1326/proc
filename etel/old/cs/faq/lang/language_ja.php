<?php
/**
* $Id: language_ja.php,v 1.7.2.11.2.5 2006/04/06 19:43:17 matteo Exp $
*
...
$PMF_LANG["err_SaveEntries"] = "<strong>名前</strong>、<strong>電子メールアドレス</strong>、<strong>カテゴリ</strong>、<strong>件名</strong>、<strong>ヘッドライン</strong>、<strong>FAQ 内容</strong>と <strong>Captcha コード</strong>は必須フィールドです!<br /><br />\n<a href=\"javascript:history.back();\">戻る</a><br /><br />\n";
$PMF_LANG["err_SaveComment"] = "<strong>名前</strong>、<strong>電子メールアドレス</strong>、<strong>コメント</strong>と<strong>Captcha コード</strong>は必須項目です!<br /><br />\n<a href=\"javascript:history.back();\">戻る</a><br /><br />\n";
...
$PMF_LANG["err_sendMail"] = "<strong>名前</strong>、<strong>電子メールアドレス</strong>、<strong>質問</strong>と <strong>Captcha コード</strong>は必須項目です!<br /><br />\n<a href=\"javascript:history.back();\">戻る</a><br /><br />\n";
...
$PMF_LANG["err_SaveQuestion"] = "<strong>名前</strong>、<strong>電子メールアドレス</strong>、<strong>質問</strong>と <strong>Captcha コード</strong>は必須項目です。<br /><br /><a href=\"javascript:history.back();\">戻る</a><br /><br />\n";
...
$PMF_LANG['ad_menu_searchplugin'] = 'Firefox 検索プラグイン';
$PMF_LANG['ad_search_plugin_install'] = 'Firefox 検索プラグインのインストール';
$PMF_LANG['ad_search_plugin_title'] = 'Firefox 検索プラグインの作成';
