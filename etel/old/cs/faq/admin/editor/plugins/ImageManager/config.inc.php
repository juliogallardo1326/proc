 ...
 * @version $Id: config.inc.php,v 1.2 2005/04/21 16:08:04 thorstenr Exp $
...
*/
$IMConfig["base_dir"] = PMF_ROOT_DIR."/images/";
...
// TODO Bugfix!!!!!!!
$paths = array("admin/editor/plugins/ImageManager/manager.php", "admin/editor/plugins/ImageManager/images.php");
$IMConfig["base_url"] = str_replace($paths, "images/", $_SERVER["PHP_SELF"]);
