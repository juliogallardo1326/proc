...
if ($_POST['checkorcard'] == 'H') $checkorcard = 'H';
if ($_POST['checkorcard'] == 'C') $checkorcard = 'C';
if ($_POST['checkorcard'] == 'W') $checkorcard = 'W';
...
if($sessionAdmin!="" && $companyInfo['block_virtualterminal']==0)
{
	...
	$qry_details="SELECT * FROM `etel_dbsmain`.`cs_company_sites` WHERE `cs_gatewayId` = ".$_SESSION["gw_id"]." AND `cs_company_id` = '$i_company_id' AND cs_hide = '0'";	
...
function func_gercurrency(check){
	if (check=='set'){
		var currency = document.paymentFrm.cardtype.value;
		if(currency=='Master')
		{
		<?php $str_currency = $mastercurrency; ?>
			//document.getElementById('txt_amount').firstChild.nodeValue='(<?=$str_currency?>)';
			//document.paymentFrm.txt_rebill.value='(<?=$str_currency?>)';
			//document.paymentFrm.currency_code.value=	'<?=$str_currency?>';
		}
...
{
	var obj_form = document.paymentFrm;
...
<form action="vt_paymentfb.php" method="post" name="paymentFrm" id="paymentFrm" onsubmit="return submitOrder(this)"> 
...
<?=func_get_country_select($str_country);?> 
					 ...
					 <tr> 
                      ...
                      <tr> 
                        ...
                        <td class="tdbdr">&nbsp;<font color="#001188"> 
                          <input type="text" name="email" id="email" value="<?=$_POST['email']?>" size="40" maxlength="100" src="req"> 
                          </font></td> 
                      </tr> 
                      <tr> 
                        ...
                        <td class="tdbdr">&nbsp;<font color="#001188"> 
                          <input type="text" name="cfrm_email" value="<?=$_POST['cfrm_email']?>" size="40" maxlength="100" src="confirm|email"> 
                          </font></td> 
                      </tr> 
                      ...
                      <?php }?> 
					  <?php if ($checkorcard == 'C') { ?>
                      <tr> 
                        <td align="right" valign="middle" class="tdbdr1" height="30"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><span class="fieldname1">Name on Account</span> :</font></td> 
                        <td valign="middle" class="tdbdr"><font color="#001188"> &nbsp; 
                          <input name="bankname" type="text" id="bankname" size="17" maxlength="16" src="req">
                        </font> </td> 
                      </tr> 
                      <tr> 
                        <td align="right" valign="middle" class="tdbdr1" height="30"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><span class="fieldname1">Routing Number</span> : </font></td> 
                        <td valign="middle" class="tdbdr">&nbsp;                        <span class="style1">
                          <input name="bankroutingcode" type="text" id="bankroutingcode"size="17" maxlength="16"  src="req">
                        </span></td> 
                      </tr> 
                      <tr> 
                        <td align="right" valign="middle" class="tdbdr1" height="30"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><span class="fieldname1">Account Number</span> :</font></td> 
                        <td valign="middle" class="tdbdr">&nbsp; <span class="style1">
                          <input name="bankaccountnumber" type="text" id="bankaccountnumber"     size="17" src="req">
                        </span></td> 
                      </tr> 
                      <?php }?> 
                      <tr> 
...
<!--
	...
	setupForm(document.getElementById('paymentFrm'));
