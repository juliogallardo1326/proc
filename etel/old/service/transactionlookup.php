...
$qrt_select_run="";
$cancel="";
$payment_mode = (isset($HTTP_POST_VARS['payment_mode'])?Trim($HTTP_POST_VARS['payment_mode']):"");
if ($payment_mode == "check") {
	$check_card_no= (isset($HTTP_POST_VARS['checkno'])?Trim($HTTP_POST_VARS['checkno']):"");
	$voice_auth_id = (isset($HTTP_POST_VARS['ch_voiceauthno'])?Trim($HTTP_POST_VARS['ch_voiceauthno']):"");
	$telephone_no = (isset($HTTP_POST_VARS['ch_telephoneno'])?Trim($HTTP_POST_VARS['ch_telephoneno']):"");
	$transaction_no = (isset($HTTP_POST_VARS['ch_transactionno'])?Trim($HTTP_POST_VARS['ch_transactionno']):"");
	$trans_type = "and a.checkorcard='C'";
} else {
	$trans_type = "and a.checkorcard='H'";
	$check_card_no= (isset($HTTP_POST_VARS['cardno'])?Trim($HTTP_POST_VARS['cardno']):"");
	$voice_auth_id = (isset($HTTP_POST_VARS['cc_voiceauthno'])?Trim($HTTP_POST_VARS['cc_voiceauthno']):"");
	$telephone_no = (isset($HTTP_POST_VARS['cc_telephoneno'])?Trim($HTTP_POST_VARS['cc_telephoneno']):"");
	$transaction_no = (isset($HTTP_POST_VARS['cc_transactionno'])?Trim($HTTP_POST_VARS['cc_transactionno']):"");
}
	...
	if($check_card_no !="") {
		$whereqry .= " and a.CCnumber='$check_card_no'";
	}
	if($voice_auth_id !="") {
...
<td valign="middle" class="tdbdr"><font color="#001188">&nbsp;</font></td>
</tr>
<tr> 
...
<tr> 
<td align="right" valign="middle" class="tdbdr1"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Charge Type :</font><br></td><td valign="middle" class="tdbdr"><font color="#001188">&nbsp; <?php print $show_select_val[5];?>
</font></td>
</tr>
<tr> 
<td align="right" valign="middle" class="tdbdr1"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Charge Amount :</font><br></td><td valign="middle" class="tdbdr"><font color="#001188">&nbsp; <?php print $show_select_val[5];?>
</font></td>
</tr>

  <tr> 
	<td align="right" valign="middle" class="tdbdr1"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Name that appeared on billing statement:</font></td><td valign="middle" class="tdbdr"><font color="#001188">&nbsp;	  </font></td>
  </tr>
  ...
  <tr> 
	<td align="right" valign="middle" class="tdbdr1"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Cancelation 
	  Date :</font></td>
	<td valign="middle" class="tdbdr"><font color="#001188">&nbsp;	  </font></td>
  </tr>
  
<tr bgcolor="#3D8287"> 
	<td colspan="2" align="center" valign="middle" class="tdbdr"><p><font color="#ffffff" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Purchase 
	      Information</strong></font></p>
	  </td>
  </tr>
  <tr>
	<td align="right" valign="middle" class="tdbdr1"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Company Name  : </font></td><td valign="middle" class="tdbdr"><font color="#001188">&nbsp;	  </font></td>
  </tr>
  <tr>
	<td align="right" valign="middle" class="tdbdr1"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Website URL : </font></td><td valign="middle" class="tdbdr"><font color="#001188">&nbsp;	  </font></td>
  </tr>
  <tr> 
	<td align="right" valign="middle" class="tdbdr1"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Website Customer Service Email Address: </font></td><td valign="middle" class="tdbdr"><font color="#001188">&nbsp;	  </font></td>
  </tr>
  <tr> 
	<td align="right" valign="middle" class="tdbdr1"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Website Customer Service Telephone Number  : </font></td><td valign="middle" class="tdbdr"><font color="#001188">&nbsp; <?php print $show_select_val[14];?>
	  </font></td>
  </tr>
  <tr> 
	<td align="right" valign="middle" class="tdbdr1"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">UserName : </font></td><td valign="middle" class="tdbdr"><font color="#001188">&nbsp; <?php print $show_select_val[15];?>
	  </font></td>
 </tr>
  <tr> 
...
?>
  ...
  <p>
  <select name="select">
          <option>Not happy with Product/Service</option>
          <option selected>Cant get in touch with Merchant</option>
          <option>Changed Mind</option>
          <option>Fraudulent </option>
          <option>Spouse</option>
          <option>Did not recieve Product/Package</option>
          <option>Other</option>
    </select>
  <br>
  </p>
  <p>If Other, please describe:<br>
   <textarea name="txt_other" id="txt_other"></textarea>
</td>
			</tr>
