...
<title>:: <?=$_SESSION["gw_emails_sales"]?> ::</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="780" align="center" class="rs_bd">
  <tr>
    <td bgcolor="#F2F9F8"><img border="0" src="images/1_res.jpg" width="263" height="100" alt=""><img border="0" src="images/2_res.jpg" width="252" height="100" alt="" ><img border="0" src="images/3_res.jpg" width="263" height="100" alt=""></td>
  </tr>
</table>
    ...
    <td width="621" class="rs_rightbd" valign="middle" align="center">
      <table border="0" cellpadding="0" cellspacing="1" width="550" height="350">
        ...
        <tr>
		  ...
		  <form name="addResellerForm" action="addReseller_fb.php"  method="post" onsubmit="javascript:return validation();">
	 <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" height="100">  
		 <tr>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr> 
                              <td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">Contact name:&nbsp;</font></td>
                        ...
                        <td align="left" valign="center" height="30" width="50%"><input name="repassword" type="text" style="font-family:arial;font-size:10px;width:150px" ></td>
							...
							<tr> -->
                              <td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">Email address:&nbsp;</font></td>
							...
							<tr> 
                              <td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">Confirm email address:&nbsp;</font></td>
							...
							<tr> 
                              <td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">New merchant applications monthly:&nbsp;</font></td>
							...
							<tr> 
                              <td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">Phone number:&nbsp;</font></td>
							...
							<tr> 
                              <td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">URL:&nbsp;</font></td>
                              <td align="left" valign="center" height="30" width="50%"><input name="url" type="text" style="font-family:arial;font-size:10px;width:200px" ></td>
                            </tr>
                          </table>
		  </td>
		  </tr>
		  <tr><td align="center"><a href="javascript:window.history.back();"><img src="images/back.gif" border="0"></a>&nbsp;&nbsp;&nbsp;<input type="image" id="adduser" src="images/submit.jpg"></input>
		   </td>
		</tr>
		</table>
	</form>
