...
$companytype = isset($HTTP_GET_VARS['companymode'])?$HTTP_GET_VARS['companymode']:"AC";
...
//print($qrt_select_company);
	...
	$qrt_select_company ="select distinct userId,companyname from cs_companydetails where activeuser=1 and transaction_type='tele' order by companyname";
}
...
<table border="0" cellpadding="0" width="100%" cellspacing="0" height="60%">
  <tr>
    ...
    &nbsp;
		...
		<form name="dates" action="viewCompanyNext.php"  method="get" onsubmit="return validate();">
		...
		<?php print func_select_mailcompanytype($companytype);  ?>
			...
			<tr>
			 <td height="40" valign="middle" align="center" width="50%"><font face="verdana" size="1">Merchant Type&nbsp;:&nbsp;</font><select name="companytrans_type" style="font-family:verdana;font-size:10px;WIDTH: 150px" onChange="Displaycompanytype();">
				...
				<?php func_multiselect_transaction($qrt_select_company);
				?>
				</select>
				</td></tr></table>
				</td></tr>			 
		 <tr><td align="center">&nbsp;&nbsp;&nbsp;<input type="image" id="viewcompany" SRC="<?=$tmpl_dir?>/images/view.jpg"></input></td></tr>
		</table>												
		</form>
	 </td>
	</tr>
