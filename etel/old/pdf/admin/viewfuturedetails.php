...
$qry_transdetails.=" cs_transactiondetails.userid =  $iuserid and cs_companydetails.userid= $iuserid and transactionDate >='$todate'  and transactionDate <= '$enddate' and bank_id=$ibankid and checkorcard='H' and gateway_id  ='-1' Order by cs_transactiondetails.userid";
											...
											for ($iloop2=1;$iloop2<=$inum1;$iloop2++){
												...
												$trans_type = $rst_transdetails[0];
												 ...
												 $adminapprovalforcancel=$rst_transdetails[17];
													...
													//modified part
													$qry_bankexit="select * from cs_transactiondetails where bank_id='$ibankid' and userId=$iuserid and transactionDate <'$todate'";
...
//ends here	
		...
		<td align="center" valign="center" height="30" colspan="2"><a href="projectedsettlement.php"><img border="0" SRC="<?=$tmpl_dir?>/images/back.jpg"></a>                    </td>
                  </tr>	
</table></td></tr>	
</table>
