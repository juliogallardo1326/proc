...
<td height="22" align="left" valign="top" width="1%" background="../images/menucenterbg.gif" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menutopleft.gif" width="8" height="22"></td>
          <td height="22" align="center" valign="middle" width="51%" background="../images/menucenterbg.gif" ><span class="whitehd">Batch 
          ...
          <td height="22" align="left" valign="top" width="36%" background="../images/menutoprightbg.gif" ><img alt="" SRC="<?=$tmpl_dir?>/images/spacer.gif" width="1" height="1"></td>
          <td height="22" align="right" valign="top" background="../images/menutoprightbg.gif"  width="2%" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menuright.gif" width="10" height="22"></td>
</tr>
<tr>
...
<?php				
			...
			print"<tr bgcolor='#CCCCCC'><td class='cl1'><span class='subhd'>Reference Number</span></td><td class='cl1'><span class='subhd'>First Name</span></td><td class='cl1'><span class='subhd'>Last Name</span></td><td class='cl1'><span class='subhd'>Address</span></td><td class='cl1'><span class='subhd'>Email Address</span></td><td class='cl1'><span class='subhd'>Telephone Number</span></td><td class='cl1'><span class='subhd'>Status</span></td></tr>";
				}
...
?>
	...
	<td width="1%"><img SRC="<?=$tmpl_dir?>/images/menubtmleft.gif"></td>
	      ...
	      <td width="2%" ><img SRC="<?=$tmpl_dir?>/images/menubtmright.gif"></td>
	</tr>
    </table>
    </td>
     </tr>
