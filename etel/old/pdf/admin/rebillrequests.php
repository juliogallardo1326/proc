...
function Displaycompanytype() {
	...
	document.frm_cancel_requests.action = "rebillrequests.php";
...
<tr>
  <td width="95%" valign="top" align="center"><table width="50%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td height="22" align="center" valign="middle" width="50%" background="<?=$tmpl_dir?>/images/menucenterbg.gif" ><span class="whitehd">Declined Rebills</span></td>
	...
	if ($str_from_date != "")
	{
		   ...
		   $qry_select="
				...
				FROM
					...
					cs_companydetails C 
				";
		   $qry_select .= $str_where_condition == "" ? " where " : $str_where_condition ." $bank_sql_limit $bank_sql and ";
		   $qry_select .= "B.userId = C.userId AND B.td_enable_rebill = 1 AND B.status='D'";
			if($str_to_date != "")
			{
				$qry_select .= " AND B.transactionDate BETWEEN '$str_from_date' AND'$str_to_date' ";
			}
			$qry_select .= " Order by C.companyname, B.transactionDate DESC";
			$rssel_report = mysql_query($qry_select) or dieLog(mysql_error()." <pre>$qry_select</pre>");
			$i_count = mysql_num_rows($rssel_report);
			//echo "<b>" . $qry_select . "</b>";
			if ($i_count==0)
			{
				$msgtodisplay="No Declined Rebills for this period.";
				$outhtml="y";				
			...
			if ($i_count>0)
			{
			  ...
			  while ($transInfo = mysql_fetch_assoc($rssel_report))
			  {
				if ($userId != $transInfo['userId']) {
					 ...
					 $str_data .= "<input type='hidden' name='bank_id' value='".$bank_id."'>";
					 $str_data .= "</form></tr>";
				}					
		?> <table border="0" cellpadding="0" width="100%" cellspacing="0" height="55%" align="center">
    <tr>
      <td width="95%" valign="top" align="center"><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="22" align="left" valign="top" width="1%" background="<?=$tmpl_dir?>/images/menucenterbg.gif" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menutopleft.gif" width="8" height="22"></td>
          <td height="22" align="center" valign="middle" width="50%" background="<?=$tmpl_dir?>/images/menucenterbg.gif" ><span class="whitehd">Declined Rebill Details</span></td>
          <td height="22" align="left" valign="top" width="3%" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menutopcurve.gif" width="49" height="22"></td>
          <td height="22" align="left" valign="top" width="45%" background="<?=$tmpl_dir?>/images/menutoprightbg.gif" ><img alt="" SRC="<?=$tmpl_dir?>/images/spacer.gif" width="1" height="1"></td>
          <td height="22" align="right" valign="top" background="<?=$tmpl_dir?>/images/menutoprightbg.gif"  width="1%" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menuright.gif" width="10" height="22"></td>
        </tr>
...
<?= $str_data?>
<tr>
  <td colspan="14" align="center" valign="middle" height="50"><a href="refundrequests.php"><img border="0" SRC="<?=$tmpl_dir?>/images/back.jpg"></a>&nbsp;    </td>
</tr>
</table>
</td>
</tr>
