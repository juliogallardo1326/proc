...
$access['SerializedData']['Data'] = array(
	...
	'Wire_Bank_IBAN_Number'=> array('Payment_Data','Wire','Bank_IBAN_Number'),
	'Wire_Bank_Transit_Number'=> array('Payment_Data','Wire','Wire_Bank_Transit_Number'),
...
$access = getAccessInfo("
	...
	'Wire Banking Info' as access_header,
		...
		1 as 'Wire_Bank_Sort_Code', 1 as 'Wire_Bank_VAT_Number', 1 as 'Wire_Bank_IBAN_Number', 1 as 'Wire_Bank_Transit_Number', 1 as 'Wire_Bank_Registration_Number', 1 as 'Wire_Bank_Additional_Notes'
...
$access['Data']['Wire_Bank_IBAN_Number']['Valid']='';
$access['Data']['Wire_Bank_Transit_Number']['Valid']='';
