  ...
  <tr>
    ...
    &nbsp;
		...
		<tr>
		          ...
		          <td height="22" align="center" valign="middle" width="375" background="../images/menucenterbg.gif" ><span class="whitehd">Rebilling&nbsp; 
		          ...
		          <td height="22" align="left" valign="top" width="356" background="../images/menutoprightbg.gif" ><img alt="" SRC="<?=$tmpl_dir?>/images/spacer.gif" width="1" height="1"></td>
...
?>
                                  ...
                                  <tr> 
                                    ...
                                    <td valign="middle" ><font size="1" face="Verdana" color="#000000">&nbsp; 
                                      <?=$show_select_val[31]?>
                                      </font> <img border="0" SRC="<?=$tmpl_dir?>/images/mastercard.jpg"> 
                                      <img border="0" SRC="<?=$tmpl_dir?>/images/visa.jpg"> 
                                    </td>
                                  </tr>
                                  <tr bgcolor="#CCCCCC"> 
                                  ...
                                  <tr> 
                                    <td align="right" class="tdbdr1" height="30"><font size="2" face="Verdana" color="#000000">Rebilling 
                                      Start Date : </font></td>
                                    <td class="tdbdr">&nbsp; 
                                  ...
                                  <tr> 
                                    <td align="right" valign="middle" class="tdbdr1" height="30"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Rebilling 
                                      Charge : </font></td>
                                    <td valign="middle" class="tdbdr"><font color="#001188">&nbsp; 
  ...
  <tr>
    ...
    &nbsp;
		...
		<tr>
		                ...
		                <td height="22" align="left" valign="top" width="51" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menutopcurve.gif" width="49" height="22"></td>
		                <td height="22" align="left" valign="top" width="379" background="../images/menutoprightbg.gif" ><img alt="" SRC="<?=$tmpl_dir?>/images/spacer.gif" width="1" height="1"></td>
		                <td height="22" align="right" valign="top" background="../images/menutoprightbg.gif"  width="10" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menuright.gif" width="10" height="22"></td>
		</tr>
		<tr>
		                <td class="lgnbd" colspan="5"> 
