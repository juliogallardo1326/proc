...
// ordermail.php:	The admin page functions for selecting the company for adding company user. 
...
function Displaycompanytype() {
	...
	document.dates.action = "ordermail.php";
  ...
  <tr>
	...
	<table width="50%"  border="0" cellspacing="0" cellpadding="0">
		...
		<td height="22" align="left" valign="top" width="1%" background="../images/menucenterbg.gif" nowrap><img border="0" SRC="<?=$tmpl_dir?>/images/menutopleft.gif" width="8" height="22"></td>
		  <td height="22" align="center" valign="middle" width="50%" background="../images/menucenterbg.gif" ><span class="whitehd">Email 
            Reciept </span></td>
		...
		<form name="dates" action="addmail.php"  method="GET" onSubmit="return validate();">
