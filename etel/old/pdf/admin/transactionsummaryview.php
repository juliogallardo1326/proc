<?php 
	...
	//$msgcompanyid = (isset($HTTP_GET_VARS['msgcompanyid'])?quote_smart($HTTP_GET_VARS['msgcompanyid']):"");
	...
	<tr>
          <td width="100%"  valign="top" align="center" class="lgnbd" colspan="5"> 
            <table align="center" cellpadding="8" cellspacing="0" width="100%" height="100%" border="0">
              <!--DWLayoutTable-->
              <form name="frmsummary" action="completeAccounting.php" method="POST">
                <tr> 
                ...
                <tr> 
				  ...
				  <!--<input type="hidden" name="hidcompanyid" value="<?=$msgcompanyid?>">-->
              </form>
            </table></td>
 </tr>
<tr>
