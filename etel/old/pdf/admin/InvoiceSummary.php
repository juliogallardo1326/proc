...
$sql = "select * from cs_bank where bank_id = '".$companyInfo['bank_Creditcard']."'";
$bank_result=mysql_query($sql,$cnn_cs) or dieLog(" Cannot execute query. $sql Error:".mysql_error());
$bankInfo = mysql_fetch_assoc($bank_result);
...
//NEW
	...
	//$realCalcResult = calcReal(0,$thisdate);
	//print_r($realCalcResult);
	
	//$oldCalcResult = calcReal(0,$thisdate-$companyInfo['cd_payperiod']*24*60*60);
	//print_r($oldCalcResult);

//print "Net = ".$realCalcResult['Net']."<BR>";
//print "RollOver = ".($realCalcResult['Gross']-$oldCalcResult['Gross'])."<BR>";
    ...
    <td colspan="5" class="lgnbd"><table width="100%" border="0" cellpadding="2" align="center">
        ...
        <tr align="center" valign="middle" height='20' >
		  ...
		  <table width="100%" border="0">
			...
			<?php if($bankInfo['bk_payout_support']) { ?>
            <tr height="25">
              <td><div align="right"><span class="style4">Generate Payout </span></div></td>
              <td></td>
              <td><span class="style7">
                <?="<a href='PayoutGenerate.php?companyId=$companyId&paydate=$thisdate' >Generate</a>"?>
              </span></td>
            </tr>
			<?php } ?>
          </table></td>
