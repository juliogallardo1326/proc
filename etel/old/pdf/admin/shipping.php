...
function validation() {
	var isValid = false;
	var obj_element = document.frm_shipping.elements[12];
...
function Displaycompanytype() {
	...
	document.frm_shipping.action = "shipping.php";
	document.frm_shipping.submit();
}


</script>
<form name="frm_shipping" action="shippingdetails.php" method="post" onSubmit="return validation();">
...
<table border="0" cellpadding="0" width="100%" cellspacing="0" height="55%" align="center">
  <tr>
       <td width="95%" valign="top" align="center">
		   ...
		   <input style="font-family:verdana;font-size:10px;" type="button" value="..." onclick="init(640,260,document.frm_shipping.from_date)">
		   </td></tr>
		   <tr>
		  ...
		  <input style="font-family:verdana;font-size:10px;" type="button" value="..." onclick="init(640,300,document.frm_shipping.from_to)">
		  </td>
		  </tr>
		  ...
		  <tr>
		  <td height="50" valign="middle" align="center" width="50%"> 
			  <span class="normaltext">Cancelled <input type="checkbox" name="chk_cancelled_shipping" value="Y"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  </td>
		  </tr>
