...
From cs_transactiondetails as td where (transactionId ='$td_non_unique' ) limit 1
)
UNION
 (
Select reference_number, 	  
...
From cs_transactiondetails as td where (td_non_unique in('$transactionId','$td_non_unique') && transactionId != '$transactionId') order by transactionDate desc limit 40
)
";
