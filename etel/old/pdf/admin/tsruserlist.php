       ...
       <td width="95%" valign="top" align="center">
			...
			<tr>
              ...
              <table border="1" cellpadding="3" cellspacing="0" align="center" width="100%">
			    <tr> 
                  <td background="../images/menucenterbg.gif" colspan="3"><span class="whitehd">TSR Users</span></td>
                </tr>
                <tr> 
                ...
                <?php
					$qrySelect = "select * from cs_tsrusers  where tsr_added_user_id  = $iCompanyId";
					$rstSelect = mysql_query($qrySelect,$cnn_cs);
					for($iLoop = 0;$iLoop<mysql_num_rows($rstSelect);$iLoop++) {
						$iUserId	=	mysql_result($rstSelect,$iLoop,0);	
						$sUserName	=	mysql_result($rstSelect,$iLoop,5);
						$sPassWord	=	mysql_result($rstSelect,$iLoop,6); ?>
                <tr> 
			  ...
			  <br>
			   <table border="1" cellpadding="3" cellspacing="0" align="center" width="100%">
			    <tr> 
                  <td background="../images/menucenterbg.gif" colspan="3"><span class="whitehd">Call Center Users</span></td>
                </tr>
                <tr> 
                  <td background="../images/menucenterbg.gif"><span class="whitehd">No</span></td>
                  <td background="../images/menucenterbg.gif"><span class="whitehd">User Name</span></td>
                ...
                <?php
					$qrySelect = "select * from cs_callcenterusers where company_id  = $iCompanyId";
					$rstSelect = mysql_query($qrySelect,$cnn_cs);
					for($iLoop = 0;$iLoop<mysql_num_rows($rstSelect);$iLoop++) {
						$iUserId	=	mysql_result($rstSelect,$iLoop,0);	
						$sUserName	=	mysql_result($rstSelect,$iLoop,6);
						$sPassWord	=	mysql_result($rstSelect,$iLoop,7); ?>
                <tr> 
                  <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                    <?= $iLoop+1 ?>
                    </font></td>
