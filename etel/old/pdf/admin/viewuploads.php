...
?>
<form name="viewUploadsForm" action="viewuploads.php" method="post">
...
<?php					for($i_loop=0;$i_loop<count($myLicenceFileArray);$i_loop++) {
							...
							print "<tr><td align='left'><a href='../gateway/".$_SESSION['gw_folder']."UserDocuments/License/$str_document_details[0]' target='_blank'><font face='verdana' size='1'>$str_document_details[0]</font></a>&nbsp;</td>";
...
<?php					for($j_loop=0;$j_loop<count($myArticlesFileArray);$j_loop++) {
							...
							print "<tr><td align='left'><a href='../gateway/".$_SESSION['gw_folder']."UserDocuments/Articles/$str_document_details[0]' target='_blank'><font face='verdana' size='1'>$str_document_details[0]</font></a>&nbsp;</td>";
...
<?php					for($k_loop=0;$k_loop<count($myHistoryFileArray);$k_loop++) {
							...
							print "<tr><td align='left'><a href='../gateway/".$_SESSION['gw_folder']."UserDocuments/History/$str_document_details[0]' target='_blank'><font face='verdana' size='1'>$str_document_details[0]</font></a>&nbsp;</td>";
							print "<td align='right' valign='middle' height='30' width='130'><font face='verdana' size='1'>Approve<input type='radio' name='reject$str_document_details[1]' value='A'";
							print $str_document_details[2] == "A" ? "checked" : "";
							print ">&nbsp;Reject<input type='radio' name='reject$str_document_details[1]' value='R'";
							print $str_document_details[2] == "R" ? "checked" : "";
...
<?php					for($l_loop=0;$l_loop<count($myProfessionalReferenceFileArray);$l_loop++) {
							...
							print "<tr><td align='left'><a href='../gateway/".$_SESSION['gw_folder']."UserDocuments/Contract/$str_document_details[0]' target='_blank'><font face='verdana' size='1'>$str_document_details[0]</font></a>&nbsp;</td>";
							print "<td align='right' valign='middle' height='30' width='130'><font face='verdana' size='1'>Approve<input type='radio' name='reject$str_document_details[1]' value='A'";
							print $str_document_details[2] == "A" ? "checked" : "";
							print ">&nbsp;Reject<input type='radio' name='reject$str_document_details[1]' value='R'";
							print $str_document_details[2] == "R" ? "checked" : "";
...
?>						
		  ...
		  <tr><td colspan="2" align="center" height="40"><a href="viewCompanyNext.php?companymode=<?= $companytype?>&companytrans_type=<?= $companytrans_type?>&companyname=<?= $companies?>"><img SRC="<?=$tmpl_dir?>/images/back.jpg" border="0"></img></a>&nbsp;&nbsp;<input type="image" SRC="<?=$tmpl_dir?>/images/submit.jpg" border="0">
		  </td></tr>
		  </table>
	</td>
      </tr>
