...
if(isset($_POST['default_disc'])||isset($_POST['default_trans']))
{
	...
	$update = array('Merchant'=>array('Default_Aff_Disc_Markup'=>round($ddm,2),'Default_Aff_Trans_Markup'=>round($dtm,2)));
...
else
{
	...
	<tr><td>Update Default Discount Rate Markup:<br /><span style="font-size:smaller">(ex. '0.1' is 0.10% of approved transaction amount per transaction)</span> </td><td><input name="default_disc" size="5" value="<?=$curUserInfo['en_info']['Merchant']['Default_Aff_Disc_Markup']?>" /></td></tr>
	<tr><td>Update Default Transaction Fee Markup:<br /><span style="font-size:smaller">(ex. '0.05' is $0.05 per approved transaction)</span> </td><td><input name="default_trans" size="5" value="<?=$curUserInfo['en_info']['Merchant']['Default_Aff_Trans_Markup']?>" /></td></tr>
	</table>
	<?php
