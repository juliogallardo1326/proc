...
<?php
 ...
 if ($str_report != "" )
 {
			if ($str_from_date != "")
					{
					    $qry_select="Select A.note_id ,A.transaction_id ,A.call_date_time,A.service_notes,B.cancelstatus,A.solved,B.phonenumber  from  cs_callnotes A,cs_transactiondetails B where B.transactionId = A.transaction_id and B.userid = ".$_SESSION["sessionlogin"]." and A.call_date_time >= '".$str_from_date."'";
					    if($str_to_date != "")
					    {
							$qry_select .= " AND A.call_date_time <= '".$str_to_date."'";
					    } 	
						$qry_select .= " Order by A.call_date_time desc";
...
?>
			...
			<td class="lgnbd" colspan="5">
			  <table width="100%" cellspacing="1" cellpadding="1" border="0" align="center"  class="lgnbd">
                ...
                <tr>
	              <td colspan="8"><font size="1" face="Verdana" ><strong>Total Records :
                    <?=$i_count; ?></strong></font>
                  </td>
			   </tr>	  
				 <tr>
		          ...
		          <td width="15%" bgcolor="#78B6C2"><span class="subhd">Call 
                    DateTime</span></td>
			 <td width="45%" bgcolor="#78B6C2"><span class="subhd">Service Notes</span></td>		 
			 <td width="10%" bgcolor="#78B6C2"><span class="subhd">Cancel Status</span></td>		 
			 <td width="4%" bgcolor="#78B6C2"><span class="subhd">Solved</span></td>		 
			 <td width="5%" bgcolor="#78B6C2"><span class="subhd">Edit</span></td>		 
			 </tr>
...
<?					
					  for($i=0;$i<mysql_num_rows($rssel_report);$i++)
					  {
						...
						$str_phone	= mysql_result($rssel_report,$i,6);
		 ...
		 <td bgcolor="#E2E2E2"><font size="1" face="Verdana" ><?=$str_phone; ?></font></td>
		 <td bgcolor="#E2E2E2"><font size="1" face="Verdana" ><?=$str_calldatetime; ?></font></td>
		 <td bgcolor="#E2E2E2"><font size="1" face="Verdana" >
		 <?php if ($str_notes == "") 
		 		{
		        print('&nbsp;');
				}
		  ...
		  ?></font></td>		 
		 <td bgcolor="#E2E2E2"><font size="1" face="Verdana" ><?=$str_cancel_status; ?></font></td>
		 <td bgcolor="#E2E2E2"><font size="1" face="Verdana" ><?=$str_solved; ?></font></td>
		 <td bgcolor="#E2E2E2"><font size="1" face="Verdana" ><a href="inquiryedit.php?noteid=<?php print($i_noteid);?>">Edit</a></font></td>
		 </tr>
		 <?php
            }				
		?>
