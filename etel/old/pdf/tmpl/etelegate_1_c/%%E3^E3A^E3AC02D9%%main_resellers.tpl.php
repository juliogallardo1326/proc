<?php /* Smarty version 2.6.9, created on 2007-03-21 14:00:02
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                          <tbody>
                                            <tr>
                                              ...
                                              <td align="left" height="30" valign="center" width="73%"><input name="companyname" title="Company Name" style="font-size: 10px; width: 200px; font-family: arial;"  onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="<?php echo $this->_tpl_vars['_POST']['companyname']; ?>
" maxlength="250" src="req"></td>
                                            </tr>
                                            <tr>
                                              <td class="bodytext" align="right" height="30" valign="center" width="27%">Contact name:&nbsp;</td>
                                              <td align="left" height="30" valign="center" width="73%"><input name="contactname" title="Contact Name" style="font-size: 10px; width: 200px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="<?php echo $this->_tpl_vars['_POST']['contactname']; ?>
" maxlength="250" src="req"></td>
                                            </tr>
                                            <tr>
                                              <td class="bodytext" align="right" height="30" valign="center" width="27%">User name:&nbsp;</td>
                                              <td align="left" height="30" valign="center" width="73%"><input name="username" title="Username" style="font-size: 10px; width: 150px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="<?php echo $this->_tpl_vars['_POST']['username']; ?>
                        ...
                        <td align="left" valign="center" height="30" width="50%"><input name="repassword" type="text" style="font-family:arial;font-size:10px;width:150px" ></td>
							...
							<tr> -->
                                            <tr>
                                              ...
                                              <td align="left" height="30" valign="center" width="73%"><input name="email" title="Contact Email Address" id="email" style="font-size: 10px; width: 200px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="<?php echo $this->_tpl_vars['_POST']['email']; ?>
" src="email"></td>
                                            </tr>
                                            <tr>
                                              <td class="bodytext" align="right" height="30" valign="center" width="27%">Confirm email address:&nbsp;</td>
                                              <td align="left" height="30" valign="center" width="73%"><input style="font-size: 10px; width: 200px; font-family: arial;" name="confirmemail"  title="Confirm Email" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" src="confirm|email"></td>
                                            </tr>
                                            <tr>
                                              <td class="bodytext" align="right" height="30" valign="center" width="27%">New merchant applications monthly:&nbsp;</td>
                                              <td align="left" height="30" valign="center" width="73%"><select style="font-size: 10px; width: 70px; font-family: arial;" name="merchantmonthly" title="Merchant Monthly Application" id="merchantmonthly" title="reqmenu"  onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)">
...
';
                                            ...
                                            <tr>
                                              ...
                                              <td align="left" height="30" valign="center" width="73%"><input name="phone"  title="Contact Phone" style="font-size: 10px; width: 120px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="<?php echo $this->_tpl_vars['_POST']['phone']; ?>
" maxlength="25" src="phone"></td>
                                            </tr>
                                            <tr>
                                              <td class="bodytext" align="right" height="30" valign="center" width="27%">URL:&nbsp;</td>
                                              <td align="left" height="30" valign="center" width="73%"><input name="url" title="Website URL" style="font-size: 10px; width: 200px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="<?php echo $this->_tpl_vars['_POST']['url']; ?>
" src="url"></td>
                                            </tr>
                                          </tbody>
                                        </table>
