<?php /* Smarty version 2.6.9, created on 2007-01-05 15:33:40
         compiled from main_applynow_form.tpl */ ?>

<form name="Frmcompany" id="Frmcompany" onsubmit="return submitform(this)" action="<?php if ($this->_tpl_vars['app']['submit']):  echo $this->_tpl_vars['app']['submit'];  else: ?>add_merchant.php?submit=1<?php endif; ?>" method="post">
  <table style="border: 1px solid rgb(80, 134, 15); background-color: white;" align="center" border="0" cellpadding="0" width="410">
    <tbody>
      <tr>
        <td colspan="2" bgcolor="#a9a792" class="subheading"><div align="center"><font color="#ffffff">
		<?php if ($this->_tpl_vars['app']['title']):  echo $this->_tpl_vars['app']['title'];  else: ?>Application Form<?php endif; ?>
		</font></div></td>
      </tr>
      <tr>
...
"></td>
	  ...
	  <?php $_from = $this->_tpl_vars['app']['fields']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['title'] => $this->_tpl_vars['field']):
?>     
	  <tr>
        <td class="bodytext" align="right" height="30" valign="center" width="404"><?php echo $this->_tpl_vars['title']; ?>
</td>
        <td align="left" height="30" width="252"><input title="<?php echo $this->_tpl_vars['title']; ?>
" name="<?php echo $this->_tpl_vars['field']['name']; ?>
" id="<?php echo $this->_tpl_vars['field']['name']; ?>
" style="font-size: 10px; font-family: arial;" value="<?php echo $this->_tpl_vars['field']['value']; ?>
" maxlength="100" valid="req"><i class="bodytext"><?php echo $this->_tpl_vars['field']['detail']; ?>
</i></td>
      </tr>
	  <?php endforeach; endif; unset($_from); ?>
      <tr>
        <td class="bodytext" align="right" height="30" valign="center" width="404">Processing Type &nbsp;</td>
...
" maxlength="75"></td>
      ...
      <tr>
        ...
        <td align="left" height="30" width="252"><select name="cd_timezone" title="Time Zone" style="font-size: 10px; width: 240px; font-family: arial;"  valid='reqmenu'>
