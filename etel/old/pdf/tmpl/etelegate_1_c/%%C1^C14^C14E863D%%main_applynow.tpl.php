<?php /* Smarty version 2.6.9, created on 2006-11-03 13:48:11
...
<table cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td width="100%" class="heading1"><br>
      </td>
    </tr>
    <tr>
      <td valign="top"><p class="bodytext">&nbsp;</p>
        <table style="border: 1px solid white;" align="center" border="0" cellpadding="0" cellspacing="0" width="87%">
          <tbody>
            <tr>
              <td class="subheading" align="center" valign="center"><div align="left">
            ...
            <tr>
              <td class="lgnbd"> <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'main_applynow_form.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?> </td>
            </tr>
