      ...
      <table cellpadding="0" cellspacing="0" width="778">
        <tr> 
          <td colspan="2" width="100%"><table cellpadding="0" cellspacing="0" width="100%">
              <tr> 
                <td width="44%"><img src="%7B$tempdir%7Dimages/index_01_sub.gif"></td>
                <td valign="top"><div align="right"><img src="{$tempdir}images/Control_Panel.jpg" height="45" width="278"></div>                  <div align="right"></div></td>
              </tr>
            </tbody></table></td>
        </tr>
		{if $allowautorefresh}<form action="" id="frm_autorefresh" method="post">{$etel_postback}<input value="{if $autorefresh}-1{else}1{/if}" name="autorefresh" type="hidden">{/if}
        <tr height="20"> 
