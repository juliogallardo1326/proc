...
<form id="processingFrm" action="{$rootdir}/secure/OrderProcessing.php" method="post" onsubmit="return submitOrder(this)">
      ...
      <td width="60%" align="left" valign="top"><table width="100%"  border="0" cellspacing="4" cellpadding="0">
		  ...
		  <tr>
		    <td valign="top" class="fieldname">
			  For an additional $1.99, check this box for access to pornheaven.com:
			</td>
			<td valign="top">
			  <input type="checkbox" name="cross" id="cross" value="">
			</td>
...
&nbsp;<br>
              ...
              {#OP_CCExample#}<a href="#" class="style1" onClick='javascript:window.open("https://www.MatureBill.com/images/creditcard.gif","","width=500,height=350")' ></a></span><span class="fieldname1"><a href="#" class="style1" onClick='javascript:window.open("https://www.MatureBill.com/images/creditcard.gif","","width=500,height=350")' ><br>
