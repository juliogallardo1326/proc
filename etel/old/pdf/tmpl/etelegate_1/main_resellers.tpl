                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                          <tbody>
                                            <tr>
                                              ...
                                              <td align="left" height="30" valign="center" width="73%"><input name="companyname" title="Company Name" style="font-size: 10px; width: 200px; font-family: arial;"  onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="{$_POST.companyname}" maxlength="250" src="req"></td>
                                            </tr>
                                            <tr>
                                              <td class="bodytext" align="right" height="30" valign="center" width="27%">Contact name:&nbsp;</td>
                                              <td align="left" height="30" valign="center" width="73%"><input name="contactname" title="Contact Name" style="font-size: 10px; width: 200px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="{$_POST.contactname}" maxlength="250" src="req"></td>
                                            </tr>
                                            <tr>
                                              <td class="bodytext" align="right" height="30" valign="center" width="27%">User name:&nbsp;</td>
                                              <td align="left" height="30" valign="center" width="73%"><input name="username" title="Username" style="font-size: 10px; width: 150px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="{$_POST.username}" maxlength="50" src="req"></td>
                                            </tr>
                                            <!--  <tr> 
                        ...
                        <td align="left" valign="center" height="30" width="50%"><input name="repassword" type="text" style="font-family:arial;font-size:10px;width:150px" ></td>
							...
							<tr> -->
                                            <tr>
                                              ...
                                              <td align="left" height="30" valign="center" width="73%"><input name="email" title="Contact Email Address" id="email" style="font-size: 10px; width: 200px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="{$_POST.email}" src="email"></td>
                                            </tr>
                                            <tr>
									  ...
									  document.getElementById('merchantmonthly').value = '{$_POST.merchantmonthly}';
                                            ...
                                            <tr>
                                              ...
                                              <td align="left" height="30" valign="center" width="73%"><input name="phone"  title="Contact Phone" style="font-size: 10px; width: 120px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="{$_POST.phone}" maxlength="25" src="phone"></td>
                                            </tr>
                                            <tr>
                                              <td class="bodytext" align="right" height="30" valign="center" width="27%">URL:&nbsp;</td>
                                              <td align="left" height="30" valign="center" width="73%"><input name="url" title="Website URL" style="font-size: 10px; width: 200px; font-family: arial;" onFocus="updatevalid(this);" onChange="updatevalid(this)" onKeyUp="updatevalid(this)" value="{$_POST.url}" src="url"></td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </font></td>
