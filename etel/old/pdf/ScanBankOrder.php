...
$merchant_id 		= (isset($HTTP_POST_VARS['MERCHANT_ID'])?trim($HTTP_POST_VARS['MERCHANT_ID']):"");
$secret_key			= (isset($HTTP_POST_VARS['MERCHANT_CODE'])?trim($HTTP_POST_VARS['MERCHANT_CODE']):"");
$tr_id 				= (isset($HTTP_POST_VARS['SHOP_NUMBER'])?trim($HTTP_POST_VARS['SHOP_NUMBER']):"");
$tr_amount 			= (isset($HTTP_POST_VARS['TRANSAC_AMOUNT'])?trim($HTTP_POST_VARS['TRANSAC_AMOUNT']):"");
$tr_currency 		= (isset($HTTP_POST_VARS['CURRENCY_CODE'])?trim($HTTP_POST_VARS['CURRENCY_CODE']):"");
$tr_description		= (isset($HTTP_POST_VARS['PRODUCT_NAME'])?trim($HTTP_POST_VARS['PRODUCT_NAME']):"");
$tr_cc_type 		= (isset($HTTP_POST_VARS['CB_TYPE'])?trim($HTTP_POST_VARS['CB_TYPE']):"");//visa or MasterCard
$tr_cc_number 		= (isset($HTTP_POST_VARS['CB_NUMBER'])?trim($HTTP_POST_VARS['CB_NUMBER']):"");
...
$tr_cvx2 			= (isset($HTTP_POST_VARS['CB_CVC'])?trim($HTTP_POST_VARS['CB_CVC']):"");
$tr_submerchant 	=  "";
$tr_testMode		=  "no";
$cus_title			= "Mr";//(isset($HTTP_POST_VARS['SHOP_ID'])?trim($HTTP_POST_VARS['SHOP_ID']):"");
$cus_firstname 		= (isset($HTTP_POST_VARS['CUSTOMER_FIRST_NAME'])?trim($HTTP_POST_VARS['CUSTOMER_FIRST_NAME']):"");
$cus_lastname 		= (isset($HTTP_POST_VARS['CUSTOMER_LAST_NAME'])?trim($HTTP_POST_VARS['CUSTOMER_LAST_NAME']):"");
$cus_address1 		= (isset($HTTP_POST_VARS['CUSTOMER_ADRESS'])?trim($HTTP_POST_VARS['CUSTOMER_ADRESS']):"");
$cus_address2		= (isset($HTTP_POST_VARS['CUSTOMER_CITY'])?trim($HTTP_POST_VARS['CUSTOMER_CITY']):"");
$cus_city			= (isset($HTTP_POST_VARS['CUSTOMER_CITY'])?trim($HTTP_POST_VARS['CUSTOMER_CITY']):"");
$cus_state			= (isset($HTTP_POST_VARS['CUSTOMER_STATE'])?trim($HTTP_POST_VARS['CUSTOMER_STATE']):"");
$cus_zip			= (isset($HTTP_POST_VARS['CUSTOMER_ZIP_CODE'])?trim($HTTP_POST_VARS['CUSTOMER_ZIP_CODE']):"");
$cus_country		= (isset($HTTP_POST_VARS['CUSTOMER_COUNTRY'])?trim($HTTP_POST_VARS['CUSTOMER_COUNTRY']):"");
$cus_phone			= (isset($HTTP_POST_VARS['CUSTOMER_PHONE'])?trim($HTTP_POST_VARS['CUSTOMER_PHONE']):"");
$cus_cellphone		= "";
$cus_email			= (isset($HTTP_POST_VARS['CUSTOMER_EMAIL'])?trim($HTTP_POST_VARS['CUSTOMER_EMAIL']):"");
$cus_ssn			= (isset($HTTP_POST_VARS['SECURITY_NO'])?trim($HTTP_POST_VARS['SECURITY_NO']):"");//social security
$cus_birthday		= (isset($HTTP_POST_VARS['BIRTH_DATE'])?trim($HTTP_POST_VARS['BIRTH_DATE']):"");
...
<form name="Scandorder" method="post" action="https://merchants.scandorderinc.com/pos/pos_entrypoint.cfm"  target="_blank">
        <table width="60%" border="0" align="center" cellspacing="0" cellpadding="0" height="50%" style="border:1px solid black">
         <tr align="center" valign="middle">
		    <td height="20" colspan="2" class="cl1"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Please 
              Donot close this page to complete the transaction and bank process</font></td>
			</tr>
