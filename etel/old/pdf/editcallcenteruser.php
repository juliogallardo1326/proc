...
if($_SESSION["sessionlogin_type"] == "tele")
{
	...
	$qry_selectdetails = "Select cc_usersid,comany_name,company_conatct_no,address,amount,user_name,user_password,voice_auth_fee from cs_callcenterusers where cc_usersid=$iCCUserId";	
	...
	if (mysql_num_rows($rst_selectdetails)>0)
	{
		...
		$str_voice_auth_fee = mysql_result($rst_selectdetails,0,7);
	}
?>
	 ...
	 <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" height="100">  
		 <tr>
		  ...
		  <tr>
			...
			<td align="left" valign="center" height="30" width="50%"><input name="voiceauthfee" type="text" style="font-family:arial;font-size:10px;width:100px" value="<?=$str_voice_auth_fee?>" maxlength="15"></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		  	<td align="right" valign="center" height="30" width="50%" colspan="2"><input name="hidcompanyname" type="hidden" style="font-family:arial;font-size:10px;width:200px" value="<?=$str_company_name?>" maxlength="250"></td>
		  </tr>
		</table>
		  </td>
		  </tr>
