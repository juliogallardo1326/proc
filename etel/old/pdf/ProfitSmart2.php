...
$my_sql['return']["04|Reference Number"] = array("source" => "td.reference_number","column"=>"reference_number");
$my_sql['return']["04|Reference Number"]["link"]["destination"] = "viewTransaction.php";
$my_sql['return']["04|Reference Number"]["link"]["parameters"] = array(
...
$my_sql['pairs']['SubGroupTypes'] = array(
	...
	array("display" => "By Payout", "value"=>"P")
	);
