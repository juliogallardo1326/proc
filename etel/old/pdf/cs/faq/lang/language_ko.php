<?php
/**
 * $Id: language_ko.php,v 1.4.2.8.2.5 2006/04/18 05:35:00 thorstenr Exp $
 *
 * Korean language file
 *
 * @author      YoungJoon Kim <yjkim@terracetech.com>
 * @since       2004-07-10
...
$PMF_LANG['ad_categ_select'] = '카테고리 언어를 선택하세요.';

// added v1.5.1 - 2005-09-06 by Thorsten
$PMF_LANG['msgSitemap'] = '사이트 맵';

// added v1.5.2 - 2005-09-23 by Lars
$PMF_LANG['err_inactiveArticle'] = '이 항목은 수정중이어서 표시할 수 없습니다.';
$PMF_LANG['msgArticleCategories'] = '항목에 해당하는 카테고리';

// added v1.5.3 - 2005-10-04 by Thorsten and Periklis
$PMF_LANG['ad_menu_searchplugin'] = 'Firefox 검색 플러그인';
$PMF_LANG['ad_search_plugin_install'] = 'Firefox 검색 플러그인을 설치합니다.';
$PMF_LANG['ad_search_plugin_title'] = 'Firefox 검색 플러그인을 생성합니다.';
$PMF_LANG['ad_search_plugin_ttitle'] = 'Firefox 검색상자 타이틀:';
$PMF_LANG['ad_search_plugin_tdesc'] = '설명:';
$PMF_LANG['ad_search_plugin_create'] = 'Firefox 검색 플러그인을 생성합니다.';
$PMF_LANG['ad_search_plugin_success'] = 'Firefox 검색 플러그인이 성공적으로 생성되었습니다.';

// added v1.6.0 - 2006-02-02 by Thorsten
$PMF_LANG['ad_entry_solution_id'] = '유일한 해결 ID';
$PMF_LANG['ad_entry_faq_record'] = 'FAQ 내용';
$PMF_LANG['ad_entry_new_revision'] = '새로운 개정(Revision)을 작성하시겠습니까?';
$PMF_LANG['ad_entry_record_administration'] = '내용 관리';
$PMF_LANG['ad_entry_changelog'] = '변경이력';
$PMF_LANG['ad_entry_revision'] = '개정';
$PMF_LANG['ad_changerev'] = '개정 선택';
$PMF_LANG['msgCaptcha'] = "읽고있는 이미지에서 문자를 입력해 주세요.";
$PMF_LANG['msgSelectCategories'] = '검색 대상...';
$PMF_LANG['msgAllCategories'] = '... 모든 카테고리';
$PMF_LANG['ad_you_should_update'] = '사용하고 있는 phpMyFAQ는 오랜된 버전입니다. 이용가능한 새 버전으로 업데이트 하시기 바랍니다.';