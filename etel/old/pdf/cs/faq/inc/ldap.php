<?php
/**
* $Id: ldap.php,v 1.8.2.1 2006/01/02 12:47:12 thorstenr Exp $
*
* LDAP
*
* The LDAP class provides methods and functions for a LDAP database.
*
...
class LDAP
{
    ...
    */
    function LDAP($ldap_server, $ldap_port, $ldap_base, $ldap_user = '', $ldap_password = '')
    {
        return $this-> __construct($ldap_server, $ldap_port, $ldap_base, $ldap_user, $ldap_password);
    }
    function __construct($ldap_server, $ldap_port, $ldap_base, $ldap_user = '', $ldap_password = '')
    {
        $this->base = $ldap_base;
