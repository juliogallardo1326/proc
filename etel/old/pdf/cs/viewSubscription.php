...
if($access['Data']['ss_rebill_status']['Value']=='active')
{
	...
	"<select name='ss_rebill_status_text'>
		...
		<option value='Did not receive Product/Package (.Net Cancel)'>Did not receive Product/Package</option>
	</select>";
...
else
{
	...
	$access['Data']['cancel_subscription']['Value']="Subscription Cancelled";
}
