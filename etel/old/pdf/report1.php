...
<tr>
	<td height="22" align="left" valign="top" width="1%" background="images/menucenterbg.gif" nowrap><img border="0" src="images/menutopleft.gif" width="8" height="22"></td>
	      <td height="22" align="center" valign="middle" width="50%" background="images/menucenterbg.gif" ><span class="whitehd">Transactions</span></td>
...
<tr> 
                  ...
                  <td align="left" width="230">
                    ...
                    </select> <select name="opt_from_year" style="font-size:10px">
                    ...
                    <input style="font-family:verdana;font-size:10px;" type="button" value="..." onclick="init(350,90,document.ledger.from_date)"> </td>
                  <td width="324" colspan="2" rowspan="8" valign="top">
					...
					<? if($_SESSION["sessionlogin_type"] == "tele") { ?>
                        ...
                        <td width="160"><font face="verdana" size="1"> 
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pass&nbsp;&nbsp;</font> 
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                          <input type="checkbox" name="trans_pass" value="p"></td>
						</tr>
						<tr> 
                        <td height="23"><font face="verdana" size="1">No Pass</font>&nbsp; 
                        </td>
						...
						<tr> 
                        <td height="23"><font face="verdana" size="1">Set to billdate</font>&nbsp; 
                        </td>
                        <td><font face="verdana" size="1">
					...
					<? } else { ?>
						<tr>
                        <td width="152" height="21"><font face="verdana" size="1">Pending Check Transactions</font> 
                        </td>
                        <td><font face="verdana" size="1">
					...
					<? } ?>
                      <tr> 
                        <td><font face="verdana" size="1">Refunded</font> 
                        </td>
                        <td><font face="verdana" size="1"> 
                      ...
                      <tr> 
                        <td><font face="verdana" size="1">Recurring Billing</font> 
                        </td>
                        <td><font face="verdana" size="1"> 
					...
					<? if($_SESSION["sessionlogin_type"] == "tele") { ?>
                      <tr> 
                        <td><font face="verdana" size="1">Set to billdate</font></td>
                        <td><font face="verdana" size="1">
					...
					<? } ?>
                      <tr> 
                        <td><font face="verdana" size="1">Display Active Subscriptions </font></td>
                        <td><font face="verdana" size="1">
                ...
                <tr> 
                  ...
                  <td align="left" width="230">
                    ...
                    <input style="font-family:verdana;font-size:10px;" type="button" value="..." onclick="init(350,90,document.ledger.from_to)"> </td> 
                </tr>   
<? 			if($_SESSION["sessionlogin_type"] == "tele") { ?>					  
			<tr> 
...
?>				  </select></td>
				  ...
				  <table width="100%"><tr>
				          <td width="37" align="left" valign="middle"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">TSR 
                            Users</font></td>
...
<?php 		}	?>
				<tr> 
                  <td  height="20"  valign="middle" align="left"> <font face="verdana" size="1">Payment 
                    Type</font></td>
			    ...
			    <?php if ($companyBlocked != 1){ ?>
                <tr> 
                  <td  height="25"  valign="middle" align="left"> <font face="verdana" size="1">Card/Check 
                    Type</font></td>
                  <td align="left" width="230"><select name="type" style="font-family:verdana;font-size:10px;WIDTH: 180px" disabled>
                    </select> </td>
                </tr>
                <tr> 
                  <td  height="54"  valign="top" align="left"> <font face="verdana" size="1">Refund Reason 
                    Reason</font></td>
                  <td align="left" width="230" valign="top"><select name="cancel_reasons[]" style="font-family:verdana;font-size:10px;WIDTH: 180px" multiple>
                      <?php print(funcFillCancellationReason('',''));?> </select> 
                  </td>
                </tr>
                <tr> 
                  <td  height="100"  valign="top" align="left"> <font face="verdana" size="1">Decline 
                    Reason</font></td>
                  <td align="left" width="230" valign="top"><select name="decline_reasons[]" style="font-family:verdana;font-size:10px;WIDTH: 180px" multiple>
                      <?php print(funcFillDeclineReason('','Check'));?> </select> 
                  </td>
                </tr>
				<?php } ?>
              </table>
...
?>
				<table>
                <tr> 
                  <td align="center" height="30" valign="bottom"><font face="verdana" size="1"><a href="javascript:show();"><img src="images/view.jpg" border="0"></a></font> 
                  </td>
                </tr>
				</table>
                <?
...
<table border="0" cellpadding="0" cellspacing="0" width="80%" height="100">
  <tr>
    <td height="22" align="left" valign="top" width="1%" background="images/menucenterbg.gif" nowrap><img border="0" src="images/menutopleft.gif" width="8" height="22"></td>
    <td height="22" align="center" valign="middle" width="50%" background="images/menucenterbg.gif" ><span class="whitehd">Batch Shipping Order Status</span></td>
    <td height="22" align="left" valign="top" width="3%" nowrap><img border="0" src="images/menutopcurve.gif" width="49" height="22"></td>
    <td height="22" align="left" valign="top" width="45%" background="images/menutoprightbg.gif" ><img alt="" src="images/spacer.gif" width="1" height="1"></td>
    <td height="22" align="right" valign="top" background="images/menutoprightbg.gif"  width="1%" nowrap><img border="0" src="images/menuright.gif" width="10" height="22"></td>
  </tr>
  <tr>
    <td width="100%"  valign="top" align="center" class="lgnbd" colspan="5"><form action=""  method="POST" enctype="multipart/form-data" name="frmBatch" id="frmBatch">
        <table width="555" border="1">
          <tr>
            <td><font face="verdana" size="1">CVS Batch File: </font></td>
            <td><font face="verdana" size="1">Batch CVSFile Format: <br>
