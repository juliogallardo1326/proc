...
function showUsers(){
	if(document.frm_accounts.usertype.options[document.frm_accounts.usertype.selectedIndex].value=="all") {
	 	document.getElementById('callcenter').style.display = "none";
	 	document.getElementById('tsruser').style.display = "none";
	}else if(document.frm_accounts.usertype.options[document.frm_accounts.usertype.selectedIndex].value=="call") {
		document.getElementById('callcenter').style.display = "";
	 	document.getElementById('tsruser').style.display = "none";
	} else if(document.frm_accounts.usertype.options[document.frm_accounts.usertype.selectedIndex].value=="tsr") {
       ...
       <td width="95%" valign="top" align="center">
		  ...
		  <tr>
			<td colspan="2">
				  ...
				  <td  valign="middle" align="right" width="35%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Call Centers</font>&nbsp;&nbsp;</td>
				  <td align="left" width="65%"><select name="callcenters[]" style="font-family:verdana;font-size:10px;WIDTH:140px" multiple>
...
?>				  </select></td>
				  ...
				  <table width="100%" cellpadding="0" cellspacing="0"><tr>
				  <td valign="middle" align="right" width="35%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">TSR Users</font>&nbsp;&nbsp;</td>
				  <td align="left" width="230" width="65%"><select name="tsrusers[]" style="font-family:verdana;font-size:10px;WIDTH:140px" multiple>
					<option value="A" selected>All Users</option>
...
?>				  </select></td>
		  ...
		  <tr><td align="center" height="35" valign="middle">
			  &nbsp;&nbsp;&nbsp;<input type="image" id="viewcompany" src="images/view.jpg"></input>
			</td></tr>		  		  
		</table>
		</td></tr>		  
		<tr>
