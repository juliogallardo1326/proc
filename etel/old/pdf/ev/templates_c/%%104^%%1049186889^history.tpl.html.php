<?php /* Smarty version 2.6.2, created on 2006-10-20 06:57:36
...
?>
              ...
              <tr>
                <td align="center" <?php if ($this->_tpl_vars['changes'][$this->_sections['i']['index']]['htt_role'] > $this->_tpl_vars['roles']['customer']): ?>bgcolor="<?php echo $this->_tpl_vars['internal_color']; ?>
" class="default_white"<?php else: ?>bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default"<?php endif; ?> nowrap>
  ...
  <tr>
    <td>
      <table bgcolor="#FFFFFF" width="100%" cellspacing="1" cellpadding="2">
        <tr>
          <td class="default">
            <b>History of Reminders Triggered for Issue #<?php echo $_GET['iss_id']; ?>
</b>
          </td>
        </tr>
        <tr>
...
" class="default_white">Date</td>
                <td bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" width="70%" class="default_white">Triggered Action</td>
              </tr>
              <?php if (isset($this->_sections['i'])) unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['reminders']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
" class="default" nowrap>
                  <?php echo $this->_tpl_vars['reminders'][$this->_sections['i']['index']]['rmh_created_date']; ?>

                </td>
                <td bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" width="85%" class="default">
                  <?php echo ((is_array($_tmp=$this->_tpl_vars['reminders'][$this->_sections['i']['index']]['rma_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
