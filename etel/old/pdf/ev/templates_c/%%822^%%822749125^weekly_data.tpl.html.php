<?php /* Smarty version 2.6.2, created on 2006-11-09 17:26:18
         compiled from reports/weekly_data.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'str_pad', 'reports/weekly_data.tpl.html', 6, false),array('modifier', 'htmlspecialchars', 'reports/weekly_data.tpl.html', 6, false),array('modifier', 'count', 'reports/weekly_data.tpl.html', 27, false),array('function', 'math', 'reports/weekly_data.tpl.html', 27, false),)), $this); ?>
<?php echo $this->_tpl_vars['data']['user']['usr_full_name']; ?>
 <?php if ($this->_tpl_vars['data']['group_name'] != ''): ?>[<?php echo $this->_tpl_vars['data']['group_name']; ?>
] <?php endif;  if ($this->_tpl_vars['report_type'] == 'weekly'): ?>Weekly <?php endif; ?>Report <?php echo $this->_tpl_vars['data']['start']; ?>
...
$this->_sections['issue']['loop'] = is_array($_loop=$this->_tpl_vars['data']['issues']['other']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['issue']['last']       = ($this->_sections['issue']['iteration'] == $this->_sections['issue']['total']);
 echo ((is_array($_tmp=$this->_tpl_vars['data']['issues']['other'][$this->_sections['issue']['index']]['iss_id'])) ? $this->_run_mod_handler('str_pad', true, $_tmp, 4, ' ', 'STR_PAD_LEFT') : str_pad($_tmp, 4, ' ', 'STR_PAD_LEFT')); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['data']['issues']['other'][$this->_sections['issue']['index']]['iss_summary'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>

<?php endfor; else: ?>
No issues touched this time period
<?php endif; ?>

<?php if ($_POST['separate_closed'] == 1): ?>
Issues Closed:

<?php if (isset($this->_sections['issue'])) unset($this->_sections['issue']);
$this->_sections['issue']['name'] = 'issue';
$this->_sections['issue']['loop'] = is_array($_loop=$this->_tpl_vars['data']['issues']['closed']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['issue']['show'] = true;
$this->_sections['issue']['max'] = $this->_sections['issue']['loop'];
$this->_sections['issue']['step'] = 1;
$this->_sections['issue']['start'] = $this->_sections['issue']['step'] > 0 ? 0 : $this->_sections['issue']['loop']-1;
...
$this->_sections['issue']['first']      = ($this->_sections['issue']['iteration'] == 1);
$this->_sections['issue']['last']       = ($this->_sections['issue']['iteration'] == $this->_sections['issue']['total']);
 echo ((is_array($_tmp=$this->_tpl_vars['data']['issues']['closed'][$this->_sections['issue']['index']]['iss_id'])) ? $this->_run_mod_handler('str_pad', true, $_tmp, 4, ' ', 'STR_PAD_LEFT') : str_pad($_tmp, 4, ' ', 'STR_PAD_LEFT')); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['data']['issues']['closed'][$this->_sections['issue']['index']]['iss_summary'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>

<?php endfor; else: ?>
No issues closed this time period
<?php endif;  endif; ?>
...
$this->_sections['status']['last']       = ($this->_sections['status']['iteration'] == $this->_sections['status']['total']);
 $this->assign('title', ($this->_tpl_vars['data']['status_counts'][$this->_sections['status']['index']]['sta_title']).":");  echo ((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('str_pad', true, $_tmp, '22') : str_pad($_tmp, '22'));  echo $this->_tpl_vars['data']['status_counts'][$this->_sections['status']['index']]['total']; ?>

<?php endfor; endif; ?>
Total Issues:         <?php echo smarty_function_math(array('equation' => "x+y",'x' => count($this->_tpl_vars['data']['issues']['other']),'y' => count($this->_tpl_vars['data']['issues']['closed'])), $this);?>
