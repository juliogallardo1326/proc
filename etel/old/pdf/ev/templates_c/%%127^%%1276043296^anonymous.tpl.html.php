<?php /* Smarty version 2.6.2, created on 2006-10-19 17:20:04
         compiled from manage/anonymous.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'manage/anonymous.tpl.html', 134, false),)), $this); ?>
            ...
            <table bgcolor="#FFFFFF" width="100%" cellspacing="1" cellpadding="2" border="0">
              ...
              function validateForm(f)
              {
                  ...
                  if ((!field1.checked) && (!field2.checked)) {
                      alert(\'Please choose whether the anonymous posting feature should be allowed or not for this project\');
                      return false;
                  }
                  if (field1.checked) {
                ...
                <td colspan="2" class="default">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="right" class="default">(Current Project: <?php echo $this->_tpl_vars['project']['prj_title']; ?>
)</td>
                    </tr>
                  </table>
                </td>
...
" align="center" class="error">
                  <?php if ($this->_tpl_vars['result'] == -1): ?>
                    An error occurred while trying to update the information.
                  <?php elseif ($this->_tpl_vars['result'] == 1): ?>
                    Thank you, the information was updated successfully.
                  <?php endif; ?>
                </td>
              </tr>
              <?php endif; ?>
