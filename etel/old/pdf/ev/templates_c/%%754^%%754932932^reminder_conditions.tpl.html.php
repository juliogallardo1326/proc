<?php /* Smarty version 2.6.2, created on 2006-10-21 18:15:36
         compiled from manage/reminder_conditions.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'manage/reminder_conditions.tpl.html', 105, false),array('function', 'cycle', 'manage/reminder_conditions.tpl.html', 208, false),array('modifier', 'escape', 'manage/reminder_conditions.tpl.html', 211, false),)), $this); ?>
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="left" class="default">
                        <b>Manage Reminder Conditions</b>
                      </td>
...
" class="link" title="view reminder action details">Action #<?php echo $this->_tpl_vars['rma_id']; ?>
...
">
                  ...
                  <?php else: ?>
                  <?php if ($this->_tpl_vars['show_field_options'] == 'yes'): ?>
                    <select name="comparison_field" class="default" onchange="disableValueField(this)">
                        <option value="-1">Please choose a field</option>
                        <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['comparable_fields'],'selected' => $this->_tpl_vars['info']['rlc_comparison_rmf_id']), $this);?>

                    </select>
                    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "error_icon.tpl.html", 'smarty_include_vars' => array('field' => 'comparison_field')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
                    <span class="default">or</span>&nbsp;
                  <?php endif; ?>
...
&id=<?php echo $this->_tpl_vars['rma_id']; ?>
" class="link">Back to Reminder Action List</a>)
                </td>
              </tr>
              <tr>
                <td colspan="2">
...
" align="center"><input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['rlc_id']; ?>
"></td>
...
" align="center" class="default">
                        <i>No conditions could be found.</i>
                      </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
