<?php /* Smarty version 2.6.2, created on 2006-10-19 16:50:26
            ...
            <table bgcolor="#FFFFFF" width="100%" cellspacing="1" cellpadding="2" border="0">
              ...
              function validateForm(f)
              {
                  ...
                  if (!hasOneSelected(f, \'projects[]\')) {
                      alert(\'Please assign the appropriate projects for this news entry.\');
...
" align="center" class="default">
                        <i>No news entries could be found.</i>
                      </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
