<?php /* Smarty version 2.6.2, created on 2006-10-19 16:50:17
         compiled from manage/email_responses.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'manage/email_responses.tpl.html', 62, false),array('function', 'cycle', 'manage/email_responses.tpl.html', 130, false),array('modifier', 'escape', 'manage/email_responses.tpl.html', 72, false),)), $this); ?>
...
" nowrap><input type="button" value="All" class="shortcut" onClick="javascript:toggleSelectAll(this.form, 'items[]');"></td>
                      <td width="60%" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
...
" align="center"><input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['ere_id']; ?>
"></td>
