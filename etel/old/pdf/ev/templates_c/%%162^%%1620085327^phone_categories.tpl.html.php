<?php /* Smarty version 2.6.2, created on 2006-10-19 17:00:26
         compiled from manage/phone_categories.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage/phone_categories.tpl.html', 114, false),)), $this); ?>
        ...
        <tr>
          <td>
            <table bgcolor="#FFFFFF" width="100%" cellspacing="1" cellpadding="2" border="0">
              ...
              <form name="phone_category_form" onSubmit="javascript:return validateForm(this);" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>
">
...
">
              ...
              <tr>
                <td class="default" nowrap>
                  <b>Manage Phone Support Categories</b>
                </td>
...
" width="100%">
                  <input type="text" name="title" size="40" class="default" value="<?php echo $this->_tpl_vars['info']['phc_title']; ?>
">
...
" align="center">
              ...
              <tr>
                <td colspan="2" class="default">
                  <b>Existing Phone Support Categories:</b>
                </td>
              </tr>
              <tr>
                <td colspan="2">
...
" align="center"><input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['phc_id']; ?>
"></td>
                      <td width="100%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<a class="link" href="<?php echo $_SERVER['PHP_SELF']; ?>
?cat=edit&id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['phc_id']; ?>
&prj_id=<?php echo $this->_tpl_vars['project']['prj_id']; ?>
" title="update this entry"><?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['phc_title']; ?>
</a>
                      </td>
                    </tr>
                    <?php endfor; else: ?>
...
" align="center" class="default">
                        <i>No phone support categories could be found.</i>
                      </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
