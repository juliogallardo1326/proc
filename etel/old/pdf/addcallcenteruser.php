...
function validation() {
	...
	trimSpace(document.adduser.voiceauthfee)
	if (document.adduser.voiceauthfee.value =="") {
		alert("Please enter voice authorization fee.");
		document.adduser.voiceauthfee.focus();
		return false;
	}
	if (isNaN(document.adduser.voiceauthfee.value)) {
	 ...
	 <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" height="100">  
		 <tr>
		  ...
		  <tr>
			...
			<td align="left" valign="center" height="30" width="50%"><input name="contactnumber" type="text" style="font-family:arial;font-size:10px;width:200px" value="" maxlength="100"></td>
		  </tr>
		  <tr>
			<td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">Address:&nbsp;</font></td>
			<td align="left" valign="center" height="30" width="50%"><textarea name="address" rows="5" cols="50" style="font-family:arial;font-size:10px;width:200px"></textarea></td>
		  </tr>
		  <tr>
			<td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">Amount per sale $:&nbsp;</font></td>
			<td align="left" valign="center" height="30" width="50%"><input name="amount" type="text" style="font-family:arial;font-size:10px;width:100px" value="" maxlength="15"></td>
		  </tr>
		  <tr>
			<td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">Voice Authorization Fee $:&nbsp;</font></td>
			<td align="left" valign="center" height="30" width="50%"><input name="voiceauthfee" type="text" style="font-family:arial;font-size:10px;width:100px" value="" maxlength="15"></td>
		  </tr>
		  <tr>
			<td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">User Name:&nbsp;</font></td>
			<td align="left" valign="center" height="30" width="50%"><input name="username" type="text" style="font-family:arial;font-size:10px;width:200px" value="" maxlength="50"></td>
		  </tr>
		  <tr>
			<td align="right" valign="center" height="30" width="50%"><font face="verdana" size="1">Password:&nbsp;</font></td>
			<td align="left" valign="center" height="30" width="50%"><input name="password" type="text" style="font-family:arial;font-size:10px;width:200px" value="" maxlength="50"></td>
		  </tr>
		  <tr>
