...
/**
*
* nunusoap_parser class parses SOAP XML messages into native PHP values
*
* @author   Dietrich Ayala <dietrich@ganx4.com>
* @version  $Id: class.nunusoap_parser.php,v 1.36 2005/08/04 01:27:42 snichol Exp $
* @access   public
*/
class nunusoap_parser extends nusoap_base {
	...
	* @access   public
	*/
	function nunusoap_parser($xml,$encoding='UTF-8',$method='',$decode_utf8=true){
		parent::nusoap_base();
		$this->xml = $xml;
		...
		if(!empty($xml)){
			...
			$this->debug('Entering nunusoap_parser(), length='.strlen($xml).', encoding='.$encoding);
