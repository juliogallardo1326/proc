...
require_once('class.nusoap_parser.php');
require_once('class.nusoap_fault.php');
...
class nusoap_transport_http extends nusoap_base {
	...
	* constructor
	*/
	function nusoap_transport_http($url){
		parent::nusoap_base();
		$this->setURL($url);
...
class soap_server extends nusoap_base {
	...
	*/
	function serialize_return() {
		...
		// if fault
		if (isset($this->methodreturn) && (get_class($this->methodreturn) == 'nusoap_fault')) {
...
class wsdl extends nusoap_base {
    ...
    function parseWSDL($wsdl = '')
    {
        ...
        if (isset($wsdl_props['scheme']) && ($wsdl_props['scheme'] == 'http' || $wsdl_props['scheme'] == 'https')) {
        	...
        	// get wsdl
	        $tr = new nusoap_transport_http($wsdl);
		...
		switch(true){
			...
			case ereg('^http',$this->endpoint):
				...
				if($this->persistentConnection == true && is_object($this->persistentConnection)){
					...
					$http = new nusoap_transport_http($this->endpoint);
					if ($this->persistentConnection) {
