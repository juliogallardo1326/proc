  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="75%">
      ...
      <tr>
		...
		<td height="22" align="center" valign="middle" width="50%" background="images/menucenterbg.gif" ><span class="whitehd">Call Center User</span></td>
	...
	<form name="adduser" action="addcallcenteruserfb.php"  method="post" onsubmit="javascript:return validation();">
	 ...
	 <tr bgcolor="#78B6C2" height="25">
		...
		<td class="cl1"><span class="subhd">Contact no</span></td>
		<td class="cl1"><span class="subhd">Address</span></td>
...
<?php
	$qry_select = "select cc_usersid,comany_name,company_conatct_no,address,amount,user_name,user_password,voice_auth_fee from cs_callcenterusers where company_id=$sessioncompanyid";
	...
	if (mysql_num_rows($rst_select)>0)
	{
		for($i=0;$i<mysql_num_rows($rst_select);$i++)
		{
			...
			$str_contactno = mysql_result($rst_select,$i,2);
			$str_address = mysql_result($rst_select,$i,3);
			$str_amount = mysql_result($rst_select,$i,4);
			$str_username = mysql_result($rst_select,$i,5);
			$str_password = mysql_result($rst_select,$i,6);
			$str_voice_auth_fee = mysql_result($rst_select,$i,7);
	?>
			<tr height="25">
				...
				<td valign="middle" class="cl1"><font face="verdana" size="1"><?=$str_contactno?></font></td>
				<td valign="middle" class="cl1"><font face="verdana" size="1"><?=nl2br($str_address)?></font></td>
				<td valign="middle" class="cl1" align="right"><font face="verdana" size="1"><?=$str_amount?></font></td>
				<td valign="middle" class="cl1" align="right"><font face="verdana" size="1">&nbsp;<?=$str_voice_auth_fee?></font></td>
				<td valign="middle" class="cl1"><font face="verdana" size="1"><a href="editcallcenteruser.php?uid=<?=$i_cc_userid?>">Edit</a></font></td>
				<td valign="middle" class="cl1"><font face="verdana" size="1"><a href="deletecallcenteruser.php?uid=<?=$i_cc_userid?>">Delete</a></font></td>
			</tr>
<?php 	}
	}else{
		print "<tr><td colspan='9' class='ltbtbd'><font face='verdana' size='1'>No Records found in the database</font></td></tr>";
	}
?>
	<tr>
		<td valign="middle" class="ltbtbd" colspan="9">&nbsp;</td>
