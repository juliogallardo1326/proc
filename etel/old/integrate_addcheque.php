...
//******************************************************************//
// Package:         Skillshire
// Description:     Online Etelegate.com
...
if($voiceauth!="") {	
	...
	$nextRecurDate = strtotime( $transaction['td_recur_next_date'])+60*60*24*$subAcc['recur_day'];
		...
		$qrt_select_company = "Select companyname,transaction_type,billingdescriptor,email,send_mail,send_ecommercemail,gateway_id,bank_check from cs_companydetails where userid='$companyid'";
