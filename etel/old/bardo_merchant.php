...
<body>
<form name="frmPayment" method="post" action="https://www.bardo-secured-transactions.com/cpe/receive.asp" onSubmit="javascript:navigate('display_result.php?SHOP_NUMBER=<?=$shopeNumber?>&TRANS_TYPE=<?=$transactionType?>','receive')" target="_blank">
