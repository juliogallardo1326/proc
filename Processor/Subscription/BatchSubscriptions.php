 ...
 * Time: 1:56 PM
 */
namespace Processor\Subscription;
...
class BatchSubscriptions implements IExecutable, IBuildable, IRoutable
{
	const TITLE = 'Submit Batched Subscriptions';

	const FORM_ACTION = '/batch/subscriptions';
