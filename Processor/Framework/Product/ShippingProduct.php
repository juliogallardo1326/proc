...
use Processor\Framework\Product\Invoice\ShippingInvoice;

class ShippingProduct extends AbstractProduct
{
	const TYPE_NAME = 'shipping';
	const TYPE_DESCRIPTION = "Shipped Product";

	const FIELD_SHIPPING_NAME = 'first';
	const FIELD_LAST_NAME = 'last';

	const FIELD_SHIPPING_ADDRESS = 'shipping-address';
	const FIELD_SHIPPING_ADDRESS2 = 'shipping-address2';
	const FIELD_SHIPPING_CITY = 'shipping-city';
	const FIELD_SHIPPING_STATE = 'shipping-state';
	const FIELD_SHIPPING_ZIPCODE = 'shipping-zipcode';
	const FIELD_SHIPPING_COUNTRY = 'shipping-country';
	...
	function getFieldSet(IRequest $Request, $title = null) {
		...
		return new HTMLElement('fieldset', self::CLS_FIELDSET_PRODUCT . ' ' . self::CLS_FIELDSET_SHIPPING_PRODUCT,
//			new HTMLHeaderScript(__DIR__ . '/assets/wallet.js'),
			...
			new HTMLElement('label', 'label-' . self::FIELD_SHIPPING_NAME, "Full Name<br/>",
				new HTMLInputField(self::FIELD_SHIPPING_NAME,
			...
			"<br/><br/>",
			new HTMLElement('label', 'label-' . self::FIELD_SHIPPING_ADDRESS, "Shipping Address<br/>",
				new HTMLInputField(self::FIELD_SHIPPING_ADDRESS,
			...
			"<br/><br/>",
			new HTMLElement('label', 'label-' . self::FIELD_SHIPPING_ADDRESS, "Shipping Address #2<br/>",

				new HTMLInputField(self::FIELD_SHIPPING_ADDRESS2,
					new Attributes('size', 12),
			...
			new HTMLElement('label', 'label-' . self::FIELD_SHIPPING_ZIPCODE, "ZipCode<br/>",
				new HTMLInputField(self::FIELD_SHIPPING_ZIPCODE,
			...
			"<br/><br/>",
			new HTMLElement('label', 'label-' . self::FIELD_SHIPPING_CITY, "City<br/>",
				new HTMLInputField(self::FIELD_SHIPPING_CITY,
			...
			"<br/><br/>",
			new HTMLElement('label', 'label-' . self::FIELD_SHIPPING_STATE, "State<br/>",
				new StyleAttributes('display', 'inline-block'),
				new HTMLSelectField(self::FIELD_SHIPPING_STATE, self::$STATES,
			...
			new HTMLElement('label', 'label-' . self::FIELD_SHIPPING_COUNTRY, "Country<br/>",
//				new StyleAttributes('float', 'right'),
				new StyleAttributes('display', 'inline-block'),
				new HTMLSelectField(self::FIELD_SHIPPING_COUNTRY, self::$COUNTRIES,
	 ...
	 */
	function createNewInvoice(IRequest $Request) {
		$Invoice = new ShippingInvoice();

		$Invoice->title = $this->getDescription();
		$Invoice->date = time();
		$Invoice->total = $this->getTotalCost();

		$Invoice->address = $Request[self::FIELD_SHIPPING_ADDRESS];
		$Invoice->address2 = $Request[self::FIELD_SHIPPING_ADDRESS2];
		$Invoice->city = $Request[self::FIELD_SHIPPING_CITY];
		$Invoice->state = $Request[self::FIELD_SHIPPING_STATE];
		$Invoice->country = $Request[self::FIELD_SHIPPING_COUNTRY];
		$Invoice->zip = $Request[self::FIELD_SHIPPING_ZIPCODE];
		return $Invoice;
	}
