...
use Processor\DB\Schema\TransactionEntry as Entry;
...
class TransactionTable extends AbstractBase implements IReadableSchema {
	...
	const FETCH_CLASS = 'Processor\\DB\\Schema\\TransactionEntry';
	const SELECT_COLUMNS = 'id, status, amount, wallet_id, product_id';
	const INSERT_COLUMNS = 'status, amount, wallet_id, product_id, invoice';
	...
	function insertRow($status = null, $amount = null, $wallet_id = null, $product_id = null, $invoice = null) { 
		return $this->insert(get_defined_vars());
	}

	function getSchema() { return new TableSchema('Processor\\DB\\Schema\\TransactionEntry'); }
