...
use Processor\DB\Schema\InvoiceEntry as Entry;
...
class InvoiceTable extends AbstractBase implements IReadableSchema {
	...
	const FETCH_CLASS = 'Processor\\DB\\Schema\\InvoiceEntry';
	...
	function getSchema() { return new TableSchema('Processor\\DB\\Schema\\InvoiceEntry'); }
