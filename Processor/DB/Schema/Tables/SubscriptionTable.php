...
use Processor\DB\Schema\SubscriptionEntry as Entry;
...
class SubscriptionTable extends AbstractBase implements IReadableSchema {
	...
	const FETCH_CLASS = 'Processor\\DB\\Schema\\SubscriptionEntry';
	...
	function getSchema() { return new TableSchema('Processor\\DB\\Schema\\SubscriptionEntry'); }
